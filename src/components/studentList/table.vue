...
let stuTmp:Student = reactive({
   _id: "", clsId: "", clsName: "", name: "", avatar: "", sex: "", birthday: "", obstacleType:"", placement: "", schoolId: ""
})
                    ...
                    <el-form ref="ruleFormRef" label-width="120px" class="demo-ruleForm" status-icon>
                        ...
                        <el-form-item label="所属学校" prop="region">
                            <el-select placeholder="所属学校">
                                <el-option label="苏州市相城区特殊教育学校" value="苏州市相城区特殊教育学校" />
                                <el-option label="苏州信息职业技术学院" value="苏州信息职业技术学院" />
                            </el-select>
                        </el-form-item>
                        ...
                        <el-form-item label="Activity time" required>
                            <el-col :span="11">
                                <el-form-item prop="date1">
                                    <el-date-picker  type="date" label="Pick a date" placeholder="Pick a date"
                                        style="width: 100%" />
                                </el-form-item>
                            </el-col>
                        </el-form-item>
