...
) ENGINE = InnoDB AUTO_INCREMENT = 99 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '答题表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `answer` VALUES (95, 24, 52, '小学二年级下数学随班就读学业评估量表', '{\"__v_isShallow\":false,\"dep\":{\"w\":0,\"n\":0},\"__v_isRef\":true,\"_rawValue\":[{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"一、数与代数\\n1.有余数的除法(除数和商都是-位数) \\n2.认识除法竖式\\n3.认识万以内的数(计数单位“千”“万”，数的组成、读写和大小比较)数\\n4. 用算盘表示万以内的数\\n5.“  ”和简单的近似数\\n6.口算两位数加、减两位数(和在100以内)\\n7.笔算两、三位数的加、减，加、减法的验算\\n8.时、分、秒的认识\\n9.用有余数除法解决的简单实际问题\\n10.两步计算的加减法实际问题\",\"select\":[],\"isTrue\":[],\"isFalse\":0,\"remarks\":\"\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"二、图形与几何\\n1.认识东、南、西、北和东北、西北、东南、西南等方向，会用这些词语描绘物体所在的方向\\n2.认识分米和毫米，能够进行简单的长度单位的换算和长度测量\\n3.初步认识直角、锐角与钝角\",\"select\":[],\"isTrue\":[],\"isFalse\":\"\",\"remarks\":\"\",\"noMake\":1},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"三、统计与概率\\n1.简单数据的分类整理\\n2.用画“正”字的方法收集、整理数据\\n3.根据统计数据回答并提出问题，对数据进行简单的分析和解释\",\"select\":[],\"isTrue\":[],\"isFalse\":\"\",\"remarks\":\"\",\"noMake\":1},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"四、综合与实践\\n1．通过实践活动，感受数学在日常生活中的作用，体验运用所学的知识和方法解决简单问题的过程，获得初步的数学活动经验。\\n2.在实践活动中，了解要解决的问题和解决问题的办法。\\n3.经历实践操作的过程，进一步理解所学的内容。\",\"select\":[],\"isTrue\":[],\"isFalse\":\"\",\"remarks\":\"\",\"noMake\":1}],\"_value\":[{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"一、数与代数\\n1.有余数的除法(除数和商都是-位数) \\n2.认识除法竖式\\n3.认识万以内的数(计数单位“千”“万”，数的组成、读写和大小比较)数\\n4. 用算盘表示万以内的数\\n5.“  ”和简单的近似数\\n6.口算两位数加、减两位数(和在100以内)\\n7.笔算两、三位数的加、减，加、减法的验算\\n8.时、分、秒的认识\\n9.用有余数除法解决的简单实际问题\\n10.两步计算的加减法实际问题\",\"select\":[],\"isTrue\":[],\"isFalse\":0,\"remarks\":\"\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"二、图形与几何\\n1.认识东、南、西、北和东北、西北、东南、西南等方向，会用这些词语描绘物体所在的方向\\n2.认识分米和毫米，能够进行简单的长度单位的换算和长度测量\\n3.初步认识直角、锐角与钝角\",\"select\":[],\"isTrue\":[],\"isFalse\":\"\",\"remarks\":\"\",\"noMake\":1},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"三、统计与概率\\n1.简单数据的分类整理\\n2.用画“正”字的方法收集、整理数据\\n3.根据统计数据回答并提出问题，对数据进行简单的分析和解释\",\"select\":[],\"isTrue\":[],\"isFalse\":\"\",\"remarks\":\"\",\"noMake\":1},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"四、综合与实践\\n1．通过实践活动，感受数学在日常生活中的作用，体验运用所学的知识和方法解决简单问题的过程，获得初步的数学活动经验。\\n2.在实践活动中，了解要解决的问题和解决问题的办法。\\n3.经历实践操作的过程，进一步理解所学的内容。\",\"select\":[],\"isTrue\":[],\"isFalse\":\"\",\"remarks\":\"\",\"noMake\":1}]}', NULL, '未完成', '', '', '2023-05-04 22:35:46', NULL, NULL);
INSERT INTO `answer` VALUES (96, NULL, 52, '义务段融合状况评估', '{\"__v_isShallow\":false,\"dep\":{\"w\":0,\"n\":0},\"__v_isRef\":true,\"_rawValue\":[{\"qyestionType\":\"多选\",\"qyestionScore\":0,\"qyestionContent\":\"一、生理方面(请尽量勾选适合的所有项目，可以复选)\",\"select\":[{\"value\":\"身体状况长期不佳，常因病请假或缺课\",\"name\":\"A\"},{\"value\":\"由医院诊断现罹患有慢性疾病(___________病)\",\"name\":\"B\"},{\"value\":\"曾罹患过重大疾病(___________病_____岁时罹患)\",\"name\":\"C\"},{\"value\":\"生理动作发展较一般孩子明显的迟缓\",\"name\":\"D\"},{\"value\":\"体质特别差，无法在一般教室（需要哪些调整？         ）\",\"name\":\"E\"},{\"value\":\"生理状况与一般同年龄孩子差异不大(或差不多健康)\",\"name\":\"F\"}],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[],\"isFalse\":[\"B\",\"A\",\"D\"],\"remarks\":\"\",\"noMake\":0},{\"qyestionType\":\"多选\",\"qyestionScore\":0,\"qyestionContent\":\"二、感官动作方面(请尽量勾选适合的所有项目，可以复选)\",\"select\":[{\"value\":\"已领有残疾证(等级:______级，残疾类别:____________类)\",\"name\":\"A\"},{\"value\":\"有严重视力问题（类型：   近视，   远视，   其他          ）\",\"name\":\"B\"},{\"value\":\"经常揉眼睛，看东西会眯眼睛或贴课本或桌面贴得很近\",\"name\":\"C\"},{\"value\":\"发音不清楚，或声调不对\",\"name\":\"D\"},{\"value\":\"经常要别人大声说话或请人靠近一点再重说一遍\",\"name\":\"E\"},{\"value\":\"经常会跌倒或碰撞东西\",\"name\":\"F\"},{\"value\":\"动作明显的比一般同学慢很多\",\"name\":\"G\"},{\"value\":\"不大会(或很少)拿剪刀、筷子等需要手部精细动作的工具\",\"name\":\"H\"},{\"value\":\"不大会(或很少)跳绳、走平衡木、打球或一般学校操场的体能活动\",\"name\":\"I\"},{\"value\":\"不太会独立行走，需要轮椅、柺杖或家具等辅助工具或他人的协助\",\"name\":\"J\"},{\"value\":\"感官动作方面的发展与一般同年龄孩子差异不大，甚至更好\",\"name\":\"K\"}],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[],\"isFalse\":[\"B\",\"D\",\"H\"],\"remarks\":\"\",\"noMake\":0},{\"qyestionType\":\"多选\",\"qyestionScore\":0,\"qyestionContent\":\"三、学业表现方面(请尽量勾选适合的所有项目，可以复选)\",\"select\":[{\"value\":\"整体学业成绩长期(一学年以上)为全班最后五名\",\"name\":\"A\"},{\"value\":\"部分科目长期(一学年以上)为全班最后五名\",\"name\":\"B\"},{\"value\":\"学业表现经常起伏很大，可以由中等以上滑落到全班倒数\",\"name\":\"C\"},{\"value\":\"整体学业成绩自____年级起突然下滑，从此一蹶不振\",\"name\":\"D\"},{\"value\":\"部分学科(________科)自___年级起下滑，从此一蹶不振\",\"name\":\"E\"},{\"value\":\"不会拼音\",\"name\":\"F\"},{\"value\":\"不会认字，或会认读的字很少(比一般同学少很多)\",\"name\":\"G\"},{\"value\":\"无法读课本或考卷说明\",\"name\":\"H\"},{\"value\":\"阅读不流畅\",\"name\":\"I\"},{\"value\":\"无法理解课文大意或复述阅读内容的重点\",\"name\":\"J\"},{\"value\":\"会抄写但不知词汇意义\",\"name\":\"K\"},{\"value\":\"写字困难，连仿写或抄联络簿有困难\",\"name\":\"L\"},{\"value\":\"不会写出完整通顺的句子(尚未教到者，请在此□打X)\",\"name\":\"M\"},{\"value\":\"不会分类，如依据颜色、大小或形状等性质区分\",\"name\":\"N\"},{\"value\":\"不会一对一的数数\",\"name\":\"O\"},{\"value\":\"只能背出20以下的数字\",\"name\":\"P\"},{\"value\":\"需要手指协助运算加减\",\"name\":\"Q\"},{\"value\":\"会加减运算，但不会解应用问题\",\"name\":\"R\"},{\"value\":\"会加减，但不会乘除(尚未教到者，请在此□打X)\",\"name\":\"S\"},{\"value\":\"会加减乘除的运算，但不会解应用问题(尚未教到者，请在此□打X)\",\"name\":\"T\"},{\"value\":\"虽然学过小数、分数，但小数、分数或比例的概念差，不会运用(尚未      教到者，请在此□打X)\",\"name\":\"U\"},{\"value\":\"请务必选答此题。该生现有之学业表现大致如何？请依各项勾选： ** （1）整体学业：○1□中等以上           ○2□全班平均数左右                ○3□中下到最后30%     ○4□全班最后15%   （2）数学：  ○1□中等以上           ○2☑全班平均数左右                ○3□中下到最后30%     ○4□全班最后15%   （3）语文：  ○1□中等以上           ○2□全班平均数左右                ○3□中下到最后30%     ○4□全班最后15%\",\"name\":\"V\"}],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[],\"isFalse\":[\"B\",\"F\",\"V\"],\"remarks\":\"整体学业中等以上，在语数英三个方面，可以达到班级前50%\",\"noMake\":0},{\"qyestionType\":\"多选\",\"qyestionScore\":0,\"qyestionContent\":\"四、学习能力方面(请尽量勾选适合的所有项目，可以复选)\",\"select\":[{\"value\":\"学习速度缓慢，明显的比一般同班同学较差\",\"name\":\"A\"},{\"value\":\"记忆力差，记不住当天老师或父母的交代\",\"name\":\"B\"},{\"value\":\"注意力差．不易持续专心任何活动\",\"name\":\"C\"},{\"value\":\"组织力差，说话或做事显得凌乱，没有重点与组织\",\"name\":\"D\"},{\"value\":\"理解能力差，常弄不清楚抽象或较复杂的符号或词汇\",\"name\":\"E\"},{\"value\":\"学习能力在不同事物表现差异很大，对某些科目或事物表现得特别好(与一般同学相比在中等以上)\",\"name\":\"F\"},{\"value\":\"记忆力好,尤其是对自己感兴趣的事物\",\"name\":\"G\"},{\"value\":\"学习能力大致与一般同年龄的同学差不多，甚至更好\",\"name\":\"H\"}],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[],\"isFalse\":[\"B\",\"E\"],\"remarks\":\"\",\"noMake\":0},{\"qyestionType\":\"多选\",\"qyestionScore\":0,\"qyestionContent\":\"五、口语能力方面(请尽量勾选适合的所有项目，可以复选)\",\"select\":[{\"value\":\"口语能力表达差，无法与老师或同学沟通\",\"name\":\"A\"},{\"value\":\"听话理解能力差，常抓不到老师或同学说话的重点\",\"name\":\"B\"},{\"value\":\"不太能和别人闲谈，不太能接续别人的话题\",\"name\":\"C\"},{\"value\":\"说话不清楚，一般人不易听得懂\",\"name\":\"D\"},{\"value\":\"不喜欢听人讲解，听课比自己看书学习时显得不专心\",\"name\":\"E\"},{\"value\":\"经常重复简单的词汇或短句\",\"name\":\"F\"},{\"value\":\"不会主动表达自己的需求\",\"name\":\"G\"},{\"value\":\"口语能力与一般同年龄的同学差不多\",\"name\":\"H\"}],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[],\"isFalse\":[\"B\",\"G\"],\"remarks\":\"\",\"noMake\":0},{\"qyestionType\":\"多选\",\"qyestionScore\":0,\"qyestionContent\":\"六、团体生活方面(请尽量勾选适合的所有项目，可以复选)\",\"select\":[{\"value\":\"上课经常会随意离开座位或教室\",\"name\":\"A\"},{\"value\":\"上课经常没有反应、呆坐或打瞌睡\",\"name\":\"B\"},{\"value\":\"无法参与团体活动(游戏、比赛)\",\"name\":\"C\"},{\"value\":\"喜欢一个人独处或自己玩\",\"name\":\"D\"},{\"value\":\"下课经常一个人，没有人和他玩\",\"name\":\"E\"},{\"value\":\"上课会乱出声、走动或作弄别人而影响教室学习\",\"name\":\"F\"},{\"value\":\"爱顶嘴，公开顶撞师长的指示\",\"name\":\"G\"},{\"value\":\"经常不交作业、或不做扫地工作\",\"name\":\"H\"},{\"value\":\"会逃课、逃家、或逃学\",\"name\":\"I\"},{\"value\":\"霸道，经常要别人让他，不能忍受同学的不一样或打扰\",\"name\":\"J\"},{\"value\":\"班上大多数同学都讨厌他，会拒绝与他同座或在一起\",\"name\":\"K\"},{\"value\":\"在学校与同学相处方面和一般同年龄孩子差不多\",\"name\":\"L\"}],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[],\"isFalse\":[\"D\",\"F\"],\"remarks\":\"\",\"noMake\":0},{\"qyestionType\":\"多选\",\"qyestionScore\":0,\"qyestionContent\":\"七、个人生活适应方面(请尽量勾选所有适合的项目，可以复选)\",\"select\":[{\"value\":\"脏乱、无法维持个人卫生\",\"name\":\"A\"},{\"value\":\"不会自行穿脱衣服\",\"name\":\"B\"},{\"value\":\"不会自行上厕所，会遗尿或大便在裤子上\",\"name\":\"C\"},{\"value\":\"应变能力差，经常不会随着情境调整自己的行为或态度\",\"name\":\"D\"},{\"value\":\"动作速度经常跟不上教室(或班级团体)的活动脚步\",\"name\":\"E\"},{\"value\":\"不会自行由教室到厕所或学校内其他的地方\",\"name\":\"F\"},{\"value\":\"上课钟响经常不会自行回教室\",\"name\":\"G\"},{\"value\":\"经常忘记带上课需要的文具、书本或作业\",\"name\":\"H\"},{\"value\":\"经常遗失个人物品，不会保管自己的东西\",\"name\":\"I\"},{\"value\":\"在学校所从事的活动(休闲或社交活动)比一般同学少很多\",\"name\":\"J\"},{\"value\":\"对于环境不预期的变化（如调课、换座位）会有明显不适应的反应\",\"name\":\"K\"},{\"value\":\"可以像一般同年龄的同学照顾自己\",\"name\":\"L\"}],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[],\"isFalse\":[\"B\",\"D\",\"J\"],\"remarks\":\"\",\"noMake\":0},{\"qyestionType\":\"多选\",\"qyestionScore\":0,\"qyestionContent\":\"八、行为情绪适应方面(请尽量勾选所有适合的项目，可以复选)\",\"select\":[{\"value\":\"情绪表达不适当，和情境不合\",\"name\":\"A\"},{\"value\":\"退缩、胆子很小\",\"name\":\"B\"},{\"value\":\"脾气很大，经常会生很大的脾气、骂人\",\"name\":\"C\"},{\"value\":\"经常攻击同学或破坏物品\",\"name\":\"D\"},{\"value\":\"一不满意，就会哭闹不停\",\"name\":\"E\"},{\"value\":\"比一般同学更容易紧张、焦虑\",\"name\":\"F\"},{\"value\":\"不会保护自己，经常受同学欺负或占小便宜\",\"name\":\"G\"},{\"value\":\"待人处事或行为举止显得比一般同学幼稚、不成熟\",\"name\":\"H\"},{\"value\":\"对周遭的人或活动不太有反应，好像不感兴趣\",\"name\":\"I\"},{\"value\":\"经常重复出现相同的动作、或发出相同的声音\",\"name\":\"J\"},{\"value\":\"老师、同学生气或受伤时,不会表现出关心或担心的行为\",\"name\":\"K\"},{\"value\":\"对周遭的人感兴趣,但表现的很奇怪,令人受不了\",\"name\":\"L\"},{\"value\":\"行为与情绪表达与一般同年龄同性别的同学差不多\",\"name\":\"M\"}],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[],\"isFalse\":[\"C\",\"E\",\"I\"],\"remarks\":\"\",\"noMake\":0},{\"qyestionType\":\"多选\",\"qyestionScore\":0,\"qyestionContent\":\"九、家庭与社区方面（请尽量勾选适合的所有项目，可以复选）\",\"select\":[{\"value\":\"曾经长期（一年以上）居住在国外或偏远地区（国家_____或地区_____，共住多久_________）\",\"name\":\"A\"},{\"value\":\"放学后没有人可以提供课业上的协助或督导\",\"name\":\"B\"},{\"value\":\"放学后没有人会监控学生的行动\",\"name\":\"C\"},{\"value\":\"长期不和父母双亲同居住在一起     （目前的监护人与孩子的关系__________________）\",\"name\":\"D\"},{\"value\":\"家庭经济贫困（属于低收入户或主要家长长期失业）\",\"name\":\"E\"},{\"value\":\"家庭居住环境充满不好的影响（例如：电动玩具店、色情或赌博行业、帮派或犯罪组织）\",\"name\":\"F\"},{\"value\":\"父亲或母亲是外地户口（□父亲或□母亲，_______省）\",\"name\":\"G\"},{\"value\":\"家庭状况与一般同学差不多，或是更好\",\"name\":\"H\"}],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[],\"isFalse\":[\"B\",\"E\",\"G\"],\"remarks\":\"\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":0,\"qyestionContent\":\"十、其他：上面没有列出来项目，但根据您的观察，学生还有哪些需要被关心的问题?请尽量列举于下：\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[],\"isFalse\":0,\"remarks\":\"暂时没有附加说明了！\",\"noMake\":0}],\"_value\":[{\"qyestionType\":\"多选\",\"qyestionScore\":0,\"qyestionContent\":\"一、生理方面(请尽量勾选适合的所有项目，可以复选)\",\"select\":[{\"value\":\"身体状况长期不佳，常因病请假或缺课\",\"name\":\"A\"},{\"value\":\"由医院诊断现罹患有慢性疾病(___________病)\",\"name\":\"B\"},{\"value\":\"曾罹患过重大疾病(___________病_____岁时罹患)\",\"name\":\"C\"},{\"value\":\"生理动作发展较一般孩子明显的迟缓\",\"name\":\"D\"},{\"value\":\"体质特别差，无法在一般教室（需要哪些调整？         ）\",\"name\":\"E\"},{\"value\":\"生理状况与一般同年龄孩子差异不大(或差不多健康)\",\"name\":\"F\"}],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[],\"isFalse\":[\"B\",\"A\",\"D\"],\"remarks\":\"\",\"noMake\":0},{\"qyestionType\":\"多选\",\"qyestionScore\":0,\"qyestionContent\":\"二、感官动作方面(请尽量勾选适合的所有项目，可以复选)\",\"select\":[{\"value\":\"已领有残疾证(等级:______级，残疾类别:____________类)\",\"name\":\"A\"},{\"value\":\"有严重视力问题（类型：   近视，   远视，   其他          ）\",\"name\":\"B\"},{\"value\":\"经常揉眼睛，看东西会眯眼睛或贴课本或桌面贴得很近\",\"name\":\"C\"},{\"value\":\"发音不清楚，或声调不对\",\"name\":\"D\"},{\"value\":\"经常要别人大声说话或请人靠近一点再重说一遍\",\"name\":\"E\"},{\"value\":\"经常会跌倒或碰撞东西\",\"name\":\"F\"},{\"value\":\"动作明显的比一般同学慢很多\",\"name\":\"G\"},{\"value\":\"不大会(或很少)拿剪刀、筷子等需要手部精细动作的工具\",\"name\":\"H\"},{\"value\":\"不大会(或很少)跳绳、走平衡木、打球或一般学校操场的体能活动\",\"name\":\"I\"},{\"value\":\"不太会独立行走，需要轮椅、柺杖或家具等辅助工具或他人的协助\",\"name\":\"J\"},{\"value\":\"感官动作方面的发展与一般同年龄孩子差异不大，甚至更好\",\"name\":\"K\"}],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[],\"isFalse\":[\"B\",\"D\",\"H\"],\"remarks\":\"\",\"noMake\":0},{\"qyestionType\":\"多选\",\"qyestionScore\":0,\"qyestionContent\":\"三、学业表现方面(请尽量勾选适合的所有项目，可以复选)\",\"select\":[{\"value\":\"整体学业成绩长期(一学年以上)为全班最后五名\",\"name\":\"A\"},{\"value\":\"部分科目长期(一学年以上)为全班最后五名\",\"name\":\"B\"},{\"value\":\"学业表现经常起伏很大，可以由中等以上滑落到全班倒数\",\"name\":\"C\"},{\"value\":\"整体学业成绩自____年级起突然下滑，从此一蹶不振\",\"name\":\"D\"},{\"value\":\"部分学科(________科)自___年级起下滑，从此一蹶不振\",\"name\":\"E\"},{\"value\":\"不会拼音\",\"name\":\"F\"},{\"value\":\"不会认字，或会认读的字很少(比一般同学少很多)\",\"name\":\"G\"},{\"value\":\"无法读课本或考卷说明\",\"name\":\"H\"},{\"value\":\"阅读不流畅\",\"name\":\"I\"},{\"value\":\"无法理解课文大意或复述阅读内容的重点\",\"name\":\"J\"},{\"value\":\"会抄写但不知词汇意义\",\"name\":\"K\"},{\"value\":\"写字困难，连仿写或抄联络簿有困难\",\"name\":\"L\"},{\"value\":\"不会写出完整通顺的句子(尚未教到者，请在此□打X)\",\"name\":\"M\"},{\"value\":\"不会分类，如依据颜色、大小或形状等性质区分\",\"name\":\"N\"},{\"value\":\"不会一对一的数数\",\"name\":\"O\"},{\"value\":\"只能背出20以下的数字\",\"name\":\"P\"},{\"value\":\"需要手指协助运算加减\",\"name\":\"Q\"},{\"value\":\"会加减运算，但不会解应用问题\",\"name\":\"R\"},{\"value\":\"会加减，但不会乘除(尚未教到者，请在此□打X)\",\"name\":\"S\"},{\"value\":\"会加减乘除的运算，但不会解应用问题(尚未教到者，请在此□打X)\",\"name\":\"T\"},{\"value\":\"虽然学过小数、分数，但小数、分数或比例的概念差，不会运用(尚未      教到者，请在此□打X)\",\"name\":\"U\"},{\"value\":\"请务必选答此题。该生现有之学业表现大致如何？请依各项勾选： ** （1）整体学业：○1□中等以上           ○2□全班平均数左右                ○3□中下到最后30%     ○4□全班最后15%   （2）数学：  ○1□中等以上           ○2☑全班平均数左右                ○3□中下到最后30%     ○4□全班最后15%   （3）语文：  ○1□中等以上           ○2□全班平均数左右                ○3□中下到最后30%     ○4□全班最后15%\",\"name\":\"V\"}],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[],\"isFalse\":[\"B\",\"F\",\"V\"],\"remarks\":\"整体学业中等以上，在语数英三个方面，可以达到班级前50%\",\"noMake\":0},{\"qyestionType\":\"多选\",\"qyestionScore\":0,\"qyestionContent\":\"四、学习能力方面(请尽量勾选适合的所有项目，可以复选)\",\"select\":[{\"value\":\"学习速度缓慢，明显的比一般同班同学较差\",\"name\":\"A\"},{\"value\":\"记忆力差，记不住当天老师或父母的交代\",\"name\":\"B\"},{\"value\":\"注意力差．不易持续专心任何活动\",\"name\":\"C\"},{\"value\":\"组织力差，说话或做事显得凌乱，没有重点与组织\",\"name\":\"D\"},{\"value\":\"理解能力差，常弄不清楚抽象或较复杂的符号或词汇\",\"name\":\"E\"},{\"value\":\"学习能力在不同事物表现差异很大，对某些科目或事物表现得特别好(与一般同学相比在中等以上)\",\"name\":\"F\"},{\"value\":\"记忆力好,尤其是对自己感兴趣的事物\",\"name\":\"G\"},{\"value\":\"学习能力大致与一般同年龄的同学差不多，甚至更好\",\"name\":\"H\"}],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[],\"isFalse\":[\"B\",\"E\"],\"remarks\":\"\",\"noMake\":0},{\"qyestionType\":\"多选\",\"qyestionScore\":0,\"qyestionContent\":\"五、口语能力方面(请尽量勾选适合的所有项目，可以复选)\",\"select\":[{\"value\":\"口语能力表达差，无法与老师或同学沟通\",\"name\":\"A\"},{\"value\":\"听话理解能力差，常抓不到老师或同学说话的重点\",\"name\":\"B\"},{\"value\":\"不太能和别人闲谈，不太能接续别人的话题\",\"name\":\"C\"},{\"value\":\"说话不清楚，一般人不易听得懂\",\"name\":\"D\"},{\"value\":\"不喜欢听人讲解，听课比自己看书学习时显得不专心\",\"name\":\"E\"},{\"value\":\"经常重复简单的词汇或短句\",\"name\":\"F\"},{\"value\":\"不会主动表达自己的需求\",\"name\":\"G\"},{\"value\":\"口语能力与一般同年龄的同学差不多\",\"name\":\"H\"}],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[],\"isFalse\":[\"B\",\"G\"],\"remarks\":\"\",\"noMake\":0},{\"qyestionType\":\"多选\",\"qyestionScore\":0,\"qyestionContent\":\"六、团体生活方面(请尽量勾选适合的所有项目，可以复选)\",\"select\":[{\"value\":\"上课经常会随意离开座位或教室\",\"name\":\"A\"},{\"value\":\"上课经常没有反应、呆坐或打瞌睡\",\"name\":\"B\"},{\"value\":\"无法参与团体活动(游戏、比赛)\",\"name\":\"C\"},{\"value\":\"喜欢一个人独处或自己玩\",\"name\":\"D\"},{\"value\":\"下课经常一个人，没有人和他玩\",\"name\":\"E\"},{\"value\":\"上课会乱出声、走动或作弄别人而影响教室学习\",\"name\":\"F\"},{\"value\":\"爱顶嘴，公开顶撞师长的指示\",\"name\":\"G\"},{\"value\":\"经常不交作业、或不做扫地工作\",\"name\":\"H\"},{\"value\":\"会逃课、逃家、或逃学\",\"name\":\"I\"},{\"value\":\"霸道，经常要别人让他，不能忍受同学的不一样或打扰\",\"name\":\"J\"},{\"value\":\"班上大多数同学都讨厌他，会拒绝与他同座或在一起\",\"name\":\"K\"},{\"value\":\"在学校与同学相处方面和一般同年龄孩子差不多\",\"name\":\"L\"}],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[],\"isFalse\":[\"D\",\"F\"],\"remarks\":\"\",\"noMake\":0},{\"qyestionType\":\"多选\",\"qyestionScore\":0,\"qyestionContent\":\"七、个人生活适应方面(请尽量勾选所有适合的项目，可以复选)\",\"select\":[{\"value\":\"脏乱、无法维持个人卫生\",\"name\":\"A\"},{\"value\":\"不会自行穿脱衣服\",\"name\":\"B\"},{\"value\":\"不会自行上厕所，会遗尿或大便在裤子上\",\"name\":\"C\"},{\"value\":\"应变能力差，经常不会随着情境调整自己的行为或态度\",\"name\":\"D\"},{\"value\":\"动作速度经常跟不上教室(或班级团体)的活动脚步\",\"name\":\"E\"},{\"value\":\"不会自行由教室到厕所或学校内其他的地方\",\"name\":\"F\"},{\"value\":\"上课钟响经常不会自行回教室\",\"name\":\"G\"},{\"value\":\"经常忘记带上课需要的文具、书本或作业\",\"name\":\"H\"},{\"value\":\"经常遗失个人物品，不会保管自己的东西\",\"name\":\"I\"},{\"value\":\"在学校所从事的活动(休闲或社交活动)比一般同学少很多\",\"name\":\"J\"},{\"value\":\"对于环境不预期的变化（如调课、换座位）会有明显不适应的反应\",\"name\":\"K\"},{\"value\":\"可以像一般同年龄的同学照顾自己\",\"name\":\"L\"}],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[],\"isFalse\":[\"B\",\"D\",\"J\"],\"remarks\":\"\",\"noMake\":0},{\"qyestionType\":\"多选\",\"qyestionScore\":0,\"qyestionContent\":\"八、行为情绪适应方面(请尽量勾选所有适合的项目，可以复选)\",\"select\":[{\"value\":\"情绪表达不适当，和情境不合\",\"name\":\"A\"},{\"value\":\"退缩、胆子很小\",\"name\":\"B\"},{\"value\":\"脾气很大，经常会生很大的脾气、骂人\",\"name\":\"C\"},{\"value\":\"经常攻击同学或破坏物品\",\"name\":\"D\"},{\"value\":\"一不满意，就会哭闹不停\",\"name\":\"E\"},{\"value\":\"比一般同学更容易紧张、焦虑\",\"name\":\"F\"},{\"value\":\"不会保护自己，经常受同学欺负或占小便宜\",\"name\":\"G\"},{\"value\":\"待人处事或行为举止显得比一般同学幼稚、不成熟\",\"name\":\"H\"},{\"value\":\"对周遭的人或活动不太有反应，好像不感兴趣\",\"name\":\"I\"},{\"value\":\"经常重复出现相同的动作、或发出相同的声音\",\"name\":\"J\"},{\"value\":\"老师、同学生气或受伤时,不会表现出关心或担心的行为\",\"name\":\"K\"},{\"value\":\"对周遭的人感兴趣,但表现的很奇怪,令人受不了\",\"name\":\"L\"},{\"value\":\"行为与情绪表达与一般同年龄同性别的同学差不多\",\"name\":\"M\"}],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[],\"isFalse\":[\"C\",\"E\",\"I\"],\"remarks\":\"\",\"noMake\":0},{\"qyestionType\":\"多选\",\"qyestionScore\":0,\"qyestionContent\":\"九、家庭与社区方面（请尽量勾选适合的所有项目，可以复选）\",\"select\":[{\"value\":\"曾经长期（一年以上）居住在国外或偏远地区（国家_____或地区_____，共住多久_________）\",\"name\":\"A\"},{\"value\":\"放学后没有人可以提供课业上的协助或督导\",\"name\":\"B\"},{\"value\":\"放学后没有人会监控学生的行动\",\"name\":\"C\"},{\"value\":\"长期不和父母双亲同居住在一起     （目前的监护人与孩子的关系__________________）\",\"name\":\"D\"},{\"value\":\"家庭经济贫困（属于低收入户或主要家长长期失业）\",\"name\":\"E\"},{\"value\":\"家庭居住环境充满不好的影响（例如：电动玩具店、色情或赌博行业、帮派或犯罪组织）\",\"name\":\"F\"},{\"value\":\"父亲或母亲是外地户口（□父亲或□母亲，_______省）\",\"name\":\"G\"},{\"value\":\"家庭状况与一般同学差不多，或是更好\",\"name\":\"H\"}],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[],\"isFalse\":[\"B\",\"E\",\"G\"],\"remarks\":\"\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":0,\"qyestionContent\":\"十、其他：上面没有列出来项目，但根据您的观察，学生还有哪些需要被关心的问题?请尽量列举于下：\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[],\"isFalse\":0,\"remarks\":\"暂时没有附加说明了！\",\"noMake\":0}]}', NULL, '已完成', '', '请见文中的打钩项目', '2023-05-13 17:07:19', '2023-05-23 15:39:55', NULL);
INSERT INTO `answer` VALUES (97, 51, 52, '个案在校观察记录表', '{\"__v_isShallow\":false,\"dep\":{\"w\":0,\"n\":0},\"__v_isRef\":true,\"_rawValue\":[{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"课堂表现\",\"select\":[{\"value\":\"\",\"name\":\"A\"}],\"isTrue\":[],\"subjectivity\":\"1.上课遵守课堂纪律。\\t　\\t一节课平均能维持（   ）分钟\",\"Single\":[0],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"课堂表现\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"2.能够按照老师的指示参与课堂活动。\\t　\\t一节课平均能维持（   ）分钟\",\"Single\":[],\"isFalse\":2,\"remarks\":\"45分钟\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"课堂表现\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"3.上课认真听讲。\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"课堂表现\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"4.积极举手发言。\\t　\\t平均（   ）次/节课，回答正确率约（  ）\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"课堂表现\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"5.回答问题时声音响亮。\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"课堂表现\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"6.能否参加配对或分组的教学活动。\\t　\\t“否”请注明原因：\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"课堂表现\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"7.能否在规定时间内完成当堂作业。\\t　\\t“否”请注明原因：\",\"Single\":[],\"isFalse\":0,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"课堂表现\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"8.上课不出声吵闹。\\t　\\t吵闹频数：（   ）次/节课\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"课堂表现\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"9.能保持稳定的情绪，不随意发脾气。\\t　\\t一般能维持（   ）分钟情绪平稳\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"课堂表现\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"10.不擅自离开自己的座位。\\t　\\t平均（   ）次/节课\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"课堂表现\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"11.坐姿正确，不摇晃脑袋或身体。\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"课堂表现\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"12.不乱动同学的书本或文具。\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"课堂表现\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"13.上课不吃零食。\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":0,\"qyestionContent\":\"课堂表现\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"备注（补充其它需要关注的课堂表现）：\",\"Single\":[],\"isFalse\":0,\"remarks\":\"课堂表现很好\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"作业完成情况\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"1.按时完成课后作业。\\t　\\t“否”请注明原因：\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"作业完成情况\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"2.不少做.漏做作业。\\t　\\t“否”请注明原因：\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"作业完成情况\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"3.作业符合要求。\\t　\\t“否”请注明原因：\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"作业完成情况\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"4.字迹工整。\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"作业完成情况\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"5.完成质量较好/正确率较高。\\t　\\t正确率大约为（   ）%\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"作业完成情况\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"6.订正及时.正确。\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"作业完成情况\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"备注（补充其它需要关注的作业完成情况）：\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"言语沟通\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"1.不无故自言自语。\\t　\\t“否”请注明频数：（  ）次/（   ） \",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"言语沟通\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"2.不鹦鹉学舌地重复别人的话。\\t　\\t“否”请注明频数：（  ）次/（   ）\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"言语沟通\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"3.与人说话时，眼睛注视对方。\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"言语沟通\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"4.别人与他说话时，会有适当的回应并看着对方。\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"言语沟通\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"5.发音清晰。\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"言语沟通\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"6.能用语言表达自己的需求。\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"言语沟通\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"7.说话较流利，不结巴或断断续续。\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"言语沟通\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"8.说话有意义，符合语境与逻辑。\\t　\\t“否”请试举例：\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"言语沟通\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"9.说话有条理，而非“前言不搭后语”。\\t　\\t“否”请试举例：\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"言语沟通\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"10.会使用基本的礼貌用语。\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":0,\"qyestionContent\":\"言语沟通\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"备注：\",\"Single\":[],\"isFalse\":0,\"remarks\":\"语言交流的挺好！！\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"同伴关系\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"1.下课与同学一起玩耍。\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"同伴关系\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"2.体育课上参加集体游戏或活动。\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"同伴关系\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"3.能与同学建立起友谊。\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"同伴关系\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"4.有两三个固定的好朋友。\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"同伴关系\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"5.能与同学互帮互助。\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"同伴关系\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"6.团结同学。\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"同伴关系\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"7.与班级同学相处融洽。\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"同伴关系\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"8.人缘较好。\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"同伴关系\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"9.能主动与同学交往。\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":0,\"qyestionContent\":\"同伴关系\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"备注：\",\"Single\":[],\"isFalse\":0,\"remarks\":\"同伴关系很好\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"自理能力\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"1.仪容整洁。\",\"Single\":[],\"isFalse\":\"\",\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"自理能力\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"2.有良好的个人卫生习惯。\",\"Single\":[],\"isFalse\":\"\",\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"自理能力\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"3.上下学不迟到.早退。\",\"Single\":[],\"isFalse\":\"\",\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"自理能力\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"4.自己吃午饭。\",\"Single\":[],\"isFalse\":\"\",\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"自理能力\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"5.饮食适度。\",\"Single\":[],\"isFalse\":\"\",\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"自理能力\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"6.如厕自理。\",\"Single\":[],\"isFalse\":\"\",\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"自理能力\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"7.能看管好自己的东西。\",\"Single\":[],\"isFalse\":\"\",\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":0,\"qyestionContent\":\"自理能力\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"备注：\",\"Single\":[],\"isFalse\":\"\",\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"不良行为\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"1.有刻板行为。\\t　\\t“是”请注明频数：（   ）次/（   ）\",\"Single\":[],\"isFalse\":\"\",\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"不良行为\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"2.有明显的对抗性行为（如不听老师的指导或不遵守规章制度等）。\\t“是”请注明频数：（   ）次/（   ）\",\"Single\":[],\"isFalse\":\"\",\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"不良行为\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"3.有攻击性行为（如用脏话骂人.向别人扔东西等）。\\t　\\t“是”请注明频数：（   ）次/（   ）\",\"Single\":[],\"isFalse\":\"\",\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"不良行为\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"4.有反社会性行为（如从别人手中抢东西或喜欢给人找麻烦）。\\t　\\t“是”请注明频数：（   ）次/（   ）\",\"Single\":[],\"isFalse\":\"\",\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"不良行为\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"5.脾气不稳定，动不动就发脾气。\\t　\\t“是”请注明频数：（   ）次/（   ）\",\"Single\":[],\"isFalse\":\"\",\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"不良行为\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"6.不与人交往，喜欢独来独往。\\t　\\t“是”请注明原因：\",\"Single\":[],\"isFalse\":\"\",\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"不良行为\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"7.有自伤行为（如经常咬伤自己的手.用力撞墙等）。\\t　\\t“是”请注明频数：（   ）次/（   ）\",\"Single\":[],\"isFalse\":\"\",\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":0,\"qyestionContent\":\"不良行为\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"备注：\",\"Single\":[],\"isFalse\":\"\",\"remarks\":\"\"}],\"_value\":[{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"课堂表现\",\"select\":[{\"value\":\"\",\"name\":\"A\"}],\"isTrue\":[],\"subjectivity\":\"1.上课遵守课堂纪律。\\t　\\t一节课平均能维持（   ）分钟\",\"Single\":[0],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"课堂表现\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"2.能够按照老师的指示参与课堂活动。\\t　\\t一节课平均能维持（   ）分钟\",\"Single\":[],\"isFalse\":2,\"remarks\":\"45分钟\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"课堂表现\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"3.上课认真听讲。\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"课堂表现\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"4.积极举手发言。\\t　\\t平均（   ）次/节课，回答正确率约（  ）\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"课堂表现\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"5.回答问题时声音响亮。\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"课堂表现\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"6.能否参加配对或分组的教学活动。\\t　\\t“否”请注明原因：\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"课堂表现\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"7.能否在规定时间内完成当堂作业。\\t　\\t“否”请注明原因：\",\"Single\":[],\"isFalse\":0,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"课堂表现\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"8.上课不出声吵闹。\\t　\\t吵闹频数：（   ）次/节课\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"课堂表现\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"9.能保持稳定的情绪，不随意发脾气。\\t　\\t一般能维持（   ）分钟情绪平稳\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"课堂表现\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"10.不擅自离开自己的座位。\\t　\\t平均（   ）次/节课\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"课堂表现\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"11.坐姿正确，不摇晃脑袋或身体。\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"课堂表现\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"12.不乱动同学的书本或文具。\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"课堂表现\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"13.上课不吃零食。\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":0,\"qyestionContent\":\"课堂表现\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"备注（补充其它需要关注的课堂表现）：\",\"Single\":[],\"isFalse\":0,\"remarks\":\"课堂表现很好\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"作业完成情况\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"1.按时完成课后作业。\\t　\\t“否”请注明原因：\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"作业完成情况\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"2.不少做.漏做作业。\\t　\\t“否”请注明原因：\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"作业完成情况\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"3.作业符合要求。\\t　\\t“否”请注明原因：\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"作业完成情况\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"4.字迹工整。\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"作业完成情况\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"5.完成质量较好/正确率较高。\\t　\\t正确率大约为（   ）%\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"作业完成情况\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"6.订正及时.正确。\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"作业完成情况\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"备注（补充其它需要关注的作业完成情况）：\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"言语沟通\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"1.不无故自言自语。\\t　\\t“否”请注明频数：（  ）次/（   ） \",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"言语沟通\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"2.不鹦鹉学舌地重复别人的话。\\t　\\t“否”请注明频数：（  ）次/（   ）\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"言语沟通\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"3.与人说话时，眼睛注视对方。\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"言语沟通\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"4.别人与他说话时，会有适当的回应并看着对方。\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"言语沟通\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"5.发音清晰。\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"言语沟通\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"6.能用语言表达自己的需求。\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"言语沟通\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"7.说话较流利，不结巴或断断续续。\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"言语沟通\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"8.说话有意义，符合语境与逻辑。\\t　\\t“否”请试举例：\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"言语沟通\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"9.说话有条理，而非“前言不搭后语”。\\t　\\t“否”请试举例：\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"言语沟通\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"10.会使用基本的礼貌用语。\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":0,\"qyestionContent\":\"言语沟通\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"备注：\",\"Single\":[],\"isFalse\":0,\"remarks\":\"语言交流的挺好！！\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"同伴关系\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"1.下课与同学一起玩耍。\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"同伴关系\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"2.体育课上参加集体游戏或活动。\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"同伴关系\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"3.能与同学建立起友谊。\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"同伴关系\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"4.有两三个固定的好朋友。\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"同伴关系\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"5.能与同学互帮互助。\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"同伴关系\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"6.团结同学。\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"同伴关系\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"7.与班级同学相处融洽。\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"同伴关系\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"8.人缘较好。\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"同伴关系\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"9.能主动与同学交往。\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":0,\"qyestionContent\":\"同伴关系\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"备注：\",\"Single\":[],\"isFalse\":0,\"remarks\":\"同伴关系很好\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"自理能力\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"1.仪容整洁。\",\"Single\":[],\"isFalse\":\"\",\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"自理能力\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"2.有良好的个人卫生习惯。\",\"Single\":[],\"isFalse\":\"\",\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"自理能力\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"3.上下学不迟到.早退。\",\"Single\":[],\"isFalse\":\"\",\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"自理能力\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"4.自己吃午饭。\",\"Single\":[],\"isFalse\":\"\",\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"自理能力\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"5.饮食适度。\",\"Single\":[],\"isFalse\":\"\",\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"自理能力\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"6.如厕自理。\",\"Single\":[],\"isFalse\":\"\",\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"自理能力\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"7.能看管好自己的东西。\",\"Single\":[],\"isFalse\":\"\",\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":0,\"qyestionContent\":\"自理能力\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"备注：\",\"Single\":[],\"isFalse\":\"\",\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"不良行为\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"1.有刻板行为。\\t　\\t“是”请注明频数：（   ）次/（   ）\",\"Single\":[],\"isFalse\":\"\",\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"不良行为\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"2.有明显的对抗性行为（如不听老师的指导或不遵守规章制度等）。\\t“是”请注明频数：（   ）次/（   ）\",\"Single\":[],\"isFalse\":\"\",\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"不良行为\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"3.有攻击性行为（如用脏话骂人.向别人扔东西等）。\\t　\\t“是”请注明频数：（   ）次/（   ）\",\"Single\":[],\"isFalse\":\"\",\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"不良行为\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"4.有反社会性行为（如从别人手中抢东西或喜欢给人找麻烦）。\\t　\\t“是”请注明频数：（   ）次/（   ）\",\"Single\":[],\"isFalse\":\"\",\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"不良行为\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"5.脾气不稳定，动不动就发脾气。\\t　\\t“是”请注明频数：（   ）次/（   ）\",\"Single\":[],\"isFalse\":\"\",\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"不良行为\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"6.不与人交往，喜欢独来独往。\\t　\\t“是”请注明原因：\",\"Single\":[],\"isFalse\":\"\",\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"不良行为\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"7.有自伤行为（如经常咬伤自己的手.用力撞墙等）。\\t　\\t“是”请注明频数：（   ）次/（   ）\",\"Single\":[],\"isFalse\":\"\",\"remarks\":\"\"},{\"qyestionType\":\"主观\",\"qyestionScore\":0,\"qyestionContent\":\"不良行为\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"备注：\",\"Single\":[],\"isFalse\":\"\",\"remarks\":\"\"}]}', NULL, '未完成', '', '请见文中的打钩项目', '2023-05-13 17:10:47', '2023-05-13 17:18:36', NULL);
INSERT INTO `answer` VALUES (98, 53, 52, '基于ICF-CY编码的功能性评估----环境因素', '{\"__v_isShallow\":false,\"dep\":{\"w\":0,\"n\":0},\"__v_isRef\":true,\"_rawValue\":[{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"e310  直系亲属的支持程度\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"e1110  饮食（例如饮食的适当性，营养，数量，和连贯性）\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"e1101  药品（医疗用途的药物类型和数量）\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[],\"isFalse\":0,\"remarks\":\"\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"e115  个人日常生活使用的产品和技术(例如家具，童车，椅子，个人护理设备，改装或特别设计的设备，骨科器械)\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[],\"isFalse\":0,\"remarks\":\"\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"e125  用于沟通的产品和技术（例如电话，电视和录音设备，电脑或电子邮件，眼镜和视听力辅助设备，书写辅助设备等）\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[],\"isFalse\":3,\"remarks\":\"\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"e130  教育产品和技术（书籍，电脑，益智玩具，为学习而设计的工具，如计算机软件等）\\t\\t\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"e320  有固定的朋友（1-2个，伙伴关系良好）\\t\\t\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[],\"isFalse\":3,\"remarks\":\"\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"e410  直系亲属成员个体态度（对儿童成长的期望）\\t\\t\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[],\"isFalse\":3,\"remarks\":\"\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"e420  朋友个体态度（包容的班级环境）\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[],\"isFalse\":4,\"remarks\":\"\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"e155  私人使用建筑物的设计、建构和建筑产品和技术（校园及家庭无障碍环境的创设：例如门槛，坡道，门把，厕所，照明，对比的颜色，厨房内部）\\t\\t\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[],\"isFalse\":3,\"remarks\":\"\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"e150  公共使用建筑物的设计、建构和建筑产品和技术（例如入口，电梯，开门器，标志，助听装置，图片支持，盲文，安全设备等）\\t\\t\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[],\"isFalse\":3,\"remarks\":\"\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"e575  社会支持的服务、制度和政策（社会保障以外的公共援助）\\t\\t\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[],\"isFalse\":4,\"remarks\":\"\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"e580  健康服务（例如早期干预，技术支持和其他健康服务）\\t\\t\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\",\"noMake\":0}],\"_value\":[{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"e310  直系亲属的支持程度\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"e1110  饮食（例如饮食的适当性，营养，数量，和连贯性）\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"e1101  药品（医疗用途的药物类型和数量）\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[],\"isFalse\":0,\"remarks\":\"\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"e115  个人日常生活使用的产品和技术(例如家具，童车，椅子，个人护理设备，改装或特别设计的设备，骨科器械)\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[],\"isFalse\":0,\"remarks\":\"\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"e125  用于沟通的产品和技术（例如电话，电视和录音设备，电脑或电子邮件，眼镜和视听力辅助设备，书写辅助设备等）\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[],\"isFalse\":3,\"remarks\":\"\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"e130  教育产品和技术（书籍，电脑，益智玩具，为学习而设计的工具，如计算机软件等）\\t\\t\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"e320  有固定的朋友（1-2个，伙伴关系良好）\\t\\t\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[],\"isFalse\":3,\"remarks\":\"\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"e410  直系亲属成员个体态度（对儿童成长的期望）\\t\\t\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[],\"isFalse\":3,\"remarks\":\"\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"e420  朋友个体态度（包容的班级环境）\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[],\"isFalse\":4,\"remarks\":\"\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"e155  私人使用建筑物的设计、建构和建筑产品和技术（校园及家庭无障碍环境的创设：例如门槛，坡道，门把，厕所，照明，对比的颜色，厨房内部）\\t\\t\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[],\"isFalse\":3,\"remarks\":\"\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"e150  公共使用建筑物的设计、建构和建筑产品和技术（例如入口，电梯，开门器，标志，助听装置，图片支持，盲文，安全设备等）\\t\\t\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[],\"isFalse\":3,\"remarks\":\"\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"e575  社会支持的服务、制度和政策（社会保障以外的公共援助）\\t\\t\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[],\"isFalse\":4,\"remarks\":\"\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"e580  健康服务（例如早期干预，技术支持和其他健康服务）\\t\\t\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\",\"noMake\":0}]}', NULL, '已完成', '', '', '2023-05-23 15:50:34', NULL, NULL);
...
-- Records of clazz
-- ----------------------------
INSERT INTO `clazz` VALUES (1, 1, 2, NULL, NULL, '2023-03-23 19:49:21', '2023-05-23 14:56:29', NULL);
INSERT INTO `clazz` VALUES (2, 1, 1, '启智测试2', '测试', NULL, '2023-03-24 03:07:15', '2023-03-24 11:07:09');
INSERT INTO `clazz` VALUES (3, 1, 2, '启智测试5', '', '2023-03-24 03:07:47', '2023-05-23 15:35:24', NULL);
...
INSERT INTO `clazz` VALUES (18, 7, 2, NULL, NULL, '2023-03-31 08:17:39', '2023-05-23 14:56:55', NULL);
...
-- ----------------------------
INSERT INTO `committee` VALUES (1, 321200, '泰州特教委员会', '泰州市大伦镇天元村', '玉皇niangnia', '10088', '2023-04-04 13:57:37', '测试数据', 1, NULL, NULL, '2023-04-06 08:23:34');
INSERT INTO `committee` VALUES (2, 320509, '天庭委员会', '南天门1237号', '嫦娥爸爸', '120', '2023-04-05 19:11:11', '简介', 9, NULL, NULL, '2023-04-06 08:24:09');
INSERT INTO `committee` VALUES (3, 321202, '大猹委员会', '大猹村1号', '游瑞', '110123', '2023-04-06 00:00:00', '123123', 1, NULL, NULL, NULL);
...
INSERT INTO `exercise` VALUES (87, 52, '', '已完成', '', '', NULL, NULL, '2023-04-23 18:34:23', '2023-05-18 10:18:55', '2023-05-18 10:18:55');
INSERT INTO `exercise` VALUES (88, 52, '测试', 'word', '', '/file/download?filename=application-vnd.openxmlformats-officedocument.wordprocessingml.document-1683509152596设计文档.docx', '2023-05-17 00:00:00', NULL, NULL, NULL, NULL);
INSERT INTO `exercise` VALUES (89, 52, '', '已完成', '[{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"课堂表现\",\"select\":[{\"value\":\"\",\"name\":\"A\"}],\"isTrue\":[],\"subjectivity\":\"1.上课遵守课堂纪律。\\t　\\t一节课平均能维持（   ）分钟\",\"Single\":[0],\"isFalse\":2,\"remarks\":\"\",\"scoreSelf\":\"0\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"课堂表现\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"2.能够按照老师的指示参与课堂活动。\\t　\\t一节课平均能维持（   ）分钟\",\"Single\":[],\"isFalse\":1,\"remarks\":\"\",\"scoreSelf\":\"0\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"课堂表现\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"3.上课认真听讲。\",\"Single\":[],\"isFalse\":1,\"remarks\":\"\",\"scoreSelf\":\"0\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"课堂表现\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"4.积极举手发言。\\t　\\t平均（   ）次/节课，回答正确率约（  ）\",\"Single\":[],\"isFalse\":1,\"remarks\":\"\",\"scoreSelf\":\"0\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"课堂表现\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"5.回答问题时声音响亮。\",\"Single\":[],\"isFalse\":1,\"remarks\":\"\",\"scoreSelf\":\"0\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"课堂表现\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"6.能否参加配对或分组的教学活动。\\t　\\t“否”请注明原因：\",\"Single\":[],\"isFalse\":1,\"remarks\":\"\",\"scoreSelf\":\"0\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"课堂表现\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"7.能否在规定时间内完成当堂作业。\\t　\\t“否”请注明原因：\",\"Single\":[],\"isFalse\":1,\"remarks\":\"\",\"scoreSelf\":\"0\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"课堂表现\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"8.上课不出声吵闹。\\t　\\t吵闹频数：（   ）次/节课\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\",\"scoreSelf\":\"0\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"课堂表现\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"9.能保持稳定的情绪，不随意发脾气。\\t　\\t一般能维持（   ）分钟情绪平稳\",\"Single\":[],\"isFalse\":0,\"remarks\":\"\",\"scoreSelf\":\"0\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"课堂表现\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"10.不擅自离开自己的座位。\\t　\\t平均（   ）次/节课\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\",\"scoreSelf\":\"0\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"课堂表现\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"11.坐姿正确，不摇晃脑袋或身体。\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\",\"scoreSelf\":\"0\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"课堂表现\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"12.不乱动同学的书本或文具。\",\"Single\":[],\"isFalse\":1,\"remarks\":\"\",\"scoreSelf\":\"0\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"课堂表现\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"13.上课不吃零食。\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\",\"scoreSelf\":\"0\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":0,\"qyestionContent\":\"课堂表现\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"备注（补充其它需要关注的课堂表现）：\",\"Single\":[],\"isFalse\":0,\"remarks\":\"\",\"scoreSelf\":\"0\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"作业完成情况\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"1.按时完成课后作业。\\t　\\t“否”请注明原因：\",\"Single\":[],\"isFalse\":1,\"remarks\":\"\",\"scoreSelf\":\"0\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"作业完成情况\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"2.不少做.漏做作业。\\t　\\t“否”请注明原因：\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\",\"scoreSelf\":\"0\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"作业完成情况\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"3.作业符合要求。\\t　\\t“否”请注明原因：\",\"Single\":[],\"isFalse\":1,\"remarks\":\"\",\"scoreSelf\":\"0\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"作业完成情况\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"4.字迹工整。\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\",\"scoreSelf\":\"0\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"作业完成情况\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"5.完成质量较好/正确率较高。\\t　\\t正确率大约为（   ）%\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\",\"scoreSelf\":\"0\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"作业完成情况\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"6.订正及时.正确。\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\",\"scoreSelf\":\"0\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"作业完成情况\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"备注（补充其它需要关注的作业完成情况）：\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\",\"scoreSelf\":\"0\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"言语沟通\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"1.不无故自言自语。\\t　\\t“否”请注明频数：（  ）次/（   ） \",\"Single\":[],\"isFalse\":1,\"remarks\":\"\",\"scoreSelf\":\"0\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"言语沟通\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"2.不鹦鹉学舌地重复别人的话。\\t　\\t“否”请注明频数：（  ）次/（   ）\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\",\"scoreSelf\":\"0\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"言语沟通\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"3.与人说话时，眼睛注视对方。\",\"Single\":[],\"isFalse\":1,\"remarks\":\"\",\"scoreSelf\":\"0\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"言语沟通\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"4.别人与他说话时，会有适当的回应并看着对方。\",\"Single\":[],\"isFalse\":1,\"remarks\":\"\",\"scoreSelf\":\"0\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"言语沟通\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"5.发音清晰。\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\",\"scoreSelf\":\"0\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"言语沟通\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"6.能用语言表达自己的需求。\",\"Single\":[],\"isFalse\":1,\"remarks\":\"\",\"scoreSelf\":\"0\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"言语沟通\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"7.说话较流利，不结巴或断断续续。\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\",\"scoreSelf\":\"0\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"言语沟通\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"8.说话有意义，符合语境与逻辑。\\t　\\t“否”请试举例：\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\",\"scoreSelf\":\"0\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"言语沟通\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"9.说话有条理，而非“前言不搭后语”。\\t　\\t“否”请试举例：\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\",\"scoreSelf\":\"0\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"言语沟通\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"10.会使用基本的礼貌用语。\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\",\"scoreSelf\":\"0\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":0,\"qyestionContent\":\"言语沟通\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"备注：\",\"Single\":[],\"isFalse\":0,\"remarks\":\"\",\"scoreSelf\":\"0\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"同伴关系\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"1.下课与同学一起玩耍。\",\"Single\":[],\"isFalse\":1,\"remarks\":\"\",\"scoreSelf\":\"0\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"同伴关系\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"2.体育课上参加集体游戏或活动。\",\"Single\":[],\"isFalse\":1,\"remarks\":\"\",\"scoreSelf\":\"0\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"同伴关系\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"3.能与同学建立起友谊。\",\"Single\":[],\"isFalse\":1,\"remarks\":\"\",\"scoreSelf\":\"0\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"同伴关系\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"4.有两三个固定的好朋友。\",\"Single\":[],\"isFalse\":0,\"remarks\":\"\",\"scoreSelf\":\"0\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"同伴关系\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"5.能与同学互帮互助。\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\",\"scoreSelf\":\"0\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"同伴关系\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"6.团结同学。\",\"Single\":[],\"isFalse\":1,\"remarks\":\"\",\"scoreSelf\":\"0\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"同伴关系\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"7.与班级同学相处融洽。\",\"Single\":[],\"isFalse\":1,\"remarks\":\"\",\"scoreSelf\":\"0\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"同伴关系\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"8.人缘较好。\",\"Single\":[],\"isFalse\":1,\"remarks\":\"\",\"scoreSelf\":\"0\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"同伴关系\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"9.能主动与同学交往。\",\"Single\":[],\"isFalse\":1,\"remarks\":\"\",\"scoreSelf\":\"0\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":0,\"qyestionContent\":\"同伴关系\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"备注：\",\"Single\":[],\"isFalse\":0,\"remarks\":\"\",\"scoreSelf\":\"0\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"自理能力\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"1.仪容整洁。\",\"Single\":[],\"isFalse\":1,\"remarks\":\"\",\"scoreSelf\":\"0\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"自理能力\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"2.有良好的个人卫生习惯。\",\"Single\":[],\"isFalse\":1,\"remarks\":\"\",\"scoreSelf\":\"0\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"自理能力\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"3.上下学不迟到.早退。\",\"Single\":[],\"isFalse\":1,\"remarks\":\"\",\"scoreSelf\":\"0\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"自理能力\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"4.自己吃午饭。\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\",\"scoreSelf\":\"0\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"自理能力\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"5.饮食适度。\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\",\"scoreSelf\":\"0\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"自理能力\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"6.如厕自理。\",\"Single\":[],\"isFalse\":1,\"remarks\":\"\",\"scoreSelf\":\"0\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"自理能力\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"7.能看管好自己的东西。\",\"Single\":[],\"isFalse\":1,\"remarks\":\"\",\"scoreSelf\":\"0\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":0,\"qyestionContent\":\"自理能力\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"备注：\",\"Single\":[],\"isFalse\":0,\"remarks\":\"\",\"scoreSelf\":\"0\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"不良行为\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"1.有刻板行为。\\t　\\t“是”请注明频数：（   ）次/（   ）\",\"Single\":[],\"isFalse\":0,\"remarks\":\"\",\"scoreSelf\":\"0\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"不良行为\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"2.有明显的对抗性行为（如不听老师的指导或不遵守规章制度等）。\\t“是”请注明频数：（   ）次/（   ）\",\"Single\":[],\"isFalse\":1,\"remarks\":\"\",\"scoreSelf\":\"0\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"不良行为\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"3.有攻击性行为（如用脏话骂人.向别人扔东西等）。\\t　\\t“是”请注明频数：（   ）次/（   ）\",\"Single\":[],\"isFalse\":0,\"remarks\":\"\",\"scoreSelf\":\"0\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"不良行为\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"4.有反社会性行为（如从别人手中抢东西或喜欢给人找麻烦）。\\t　\\t“是”请注明频数：（   ）次/（   ）\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\",\"scoreSelf\":\"0\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"不良行为\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"5.脾气不稳定，动不动就发脾气。\\t　\\t“是”请注明频数：（   ）次/（   ）\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\",\"scoreSelf\":\"0\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"不良行为\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"6.不与人交往，喜欢独来独往。\\t　\\t“是”请注明原因：\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\",\"scoreSelf\":\"0\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"不良行为\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"7.有自伤行为（如经常咬伤自己的手.用力撞墙等）。\\t　\\t“是”请注明频数：（   ）次/（   ）\",\"Single\":[],\"isFalse\":2,\"remarks\":\"\",\"scoreSelf\":\"0\",\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":0,\"qyestionContent\":\"不良行为\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"备注：\",\"Single\":[],\"isFalse\":0,\"remarks\":\"\",\"scoreSelf\":\"0\",\"noMake\":0}]', '', NULL, NULL, NULL, '2023-05-18 12:15:57', '2023-05-18 12:15:57');
INSERT INTO `exercise` VALUES (90, 52, '义务教育阶段体育课程评估表', '未完成', '[{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"一、运动参与——参与体育学习与锻炼\\n\",\"select\":[{\"value\":\"\",\"name\":\"A\"}],\"isTrue\":[],\"subjectivity\":\"表现出自觉参加课外体育锻炼得习惯。\"},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"一、运动参与——体验成功与运动乐趣\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"在体验运动乐趣得过程中形成积极得体育态度。\"},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"二、学习运动知识——简要分析体育运动中得现象与问题\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"简要分析现代体育与奥运会发展过程中所发生得一些重要事件与问题\"},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"二、学习运动知识——提高体育学习与锻炼得能力\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"比较全面地掌握科学锻炼身体得基本知识与方法、如比较全面地掌握运动强度与密度、靶心率、运动处方、心率测定与运动量控制等基本知识与方法。\"},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"二、学习运动知识——掌握并运用运动技术\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"基本掌握并运用田径类运动得技术。\\n基本掌握并运用球类运动得技术与简单战术、如基本掌握并运用篮球、排球、足球、羽毛球、乒乓球、网球、毽球、珍珠球与三门球等球类项目得技术与简单战术。\\n基本掌握并运用体操类运动得技术、如基本掌握并运用器械体操、技巧、健美操、街舞、啦啦操、校园集体舞、民族舞等项目得技术动作与组合动作等。\\n基本掌握并运用游泳运动或冰雪类运动得技术。\\n基本掌握并运用武术类运动得技术。\\n基本掌握并运用较复杂得其他民族民间体育活动项目得技术。\"},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"二、学习运动知识——提高安全运动的能力\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"提高安全运动的意识\"},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"二、学习运动知识——将安全运动得意识迁移到日常生活中\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"在日常生活中形成安全行动得意识与能力、如在日常生活中走路、骑车以及特殊气候等条件下注意安全,懂得自然灾害(如地震等)发生时主动规避危险得知识与方法等\"},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"三、身体健康——掌握基本保健知识与方法\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"了解合理饮食与体育锻炼对控制体重的作用。\\n了解合理安排作息对身体健康得益处。\\n了解生活恶习对身体健康得危害并自觉抵制。\\n了解常见传染性疾病得传播途径与预防方法、如了解急性上呼吸道感染、流行性、感冒、结核病、病毒性肝炎、伤寒与菌痢的传播途径与预防方法等。\\n了解艾滋病与血吸虫病对人体得危害与预防方法。\\n\"},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"三、身体健康——全面发展体能与健身能力\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"在多种运动项目练习中提高灵敏性。\\n在多种运动项目练习中提高力量水平。\\n在多种运动项目练习中提高速度水平。\\n在多种运动项目练习中提高心肺耐力。\"},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"四、心理健康与社会适应——培养坚强得意志品质\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"积极应对各种困难,并果断做出决策。\"},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"四、心理健康与社会适应——学会调控情绪得方法\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"分析体育学习与锻炼中挫折与失败得原因,并保持稳定与积极得情绪。\"},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"四、心理健康与社会适应——形成合作意识与能力\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"在集体性体育活动中共同努力实现目标。\"},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"四、心理健康与社会适应——具有良好得体育道德\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"在体育活动与日常生活中表现出良好得道德行为。\"},{\"qyestionType\":\"主观\",\"qyestionScore\":0,\"qyestionContent\":\"\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\"}]', '', '2023-05-08 00:00:00', '2023-05-11 00:00:00', NULL, NULL, NULL);
INSERT INTO `exercise` VALUES (91, 52, '', '已完成', '[{\"qyestionType\":\"主观\",\"qyestionScore\":10,\"qyestionContent\":\"一、大便\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"0=失禁或昏迷\\n5=偶尔失禁（每周<1次）\\n10=能控制\",\"isFalse\":1,\"remarks\":\"\",\"scoreSelf\":0,\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":10,\"qyestionContent\":\"二、小便\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"0=失禁或昏迷或需由他人导尿\\n5=偶尔失禁（每24小时<1次，每周>1次）\\n10=能控制\",\"isFalse\":2,\"remarks\":\"\",\"scoreSelf\":0,\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":5,\"qyestionContent\":\"三、修饰\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"0=需帮助\\n5=独立洗脸、梳头、刷牙、剃须\",\"isFalse\":2,\"remarks\":\"\",\"scoreSelf\":0,\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":10,\"qyestionContent\":\"四、如厕\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"0=依赖别人\\n5=需部分帮助\\n10=自理\",\"isFalse\":2,\"remarks\":\"\",\"scoreSelf\":0,\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":10,\"qyestionContent\":\"五、吃饭\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"0=依赖别人\\n5=需部分帮助（夹饭、盛饭、切面包）\\n10=全面自理\",\"isFalse\":0,\"remarks\":\"\",\"scoreSelf\":0,\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":15,\"qyestionContent\":\"六、转移（床←→椅）\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"0=完全依赖别人，不能坐\\n5=需大量帮助（2人），能坐\\n10=需少量帮助（1人）或指导\\n15=自理\",\"isFalse\":1,\"remarks\":\"\",\"scoreSelf\":0,\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":15,\"qyestionContent\":\"七、活动（步行）（在病房及其周围，不包括走远路）\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"0=不能动\\n5=在轮椅上独立行动\\n10=需1人帮助步行（体力或语言指导）\\n15=独立步行（可用辅助器）\",\"isFalse\":1,\"remarks\":\"\",\"scoreSelf\":0,\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":10,\"qyestionContent\":\"八、穿衣\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"0=依赖\\n5=需一半帮助\\n10=自理（系开钮扣、关、开拉锁和穿鞋）\",\"isFalse\":4,\"remarks\":\"\",\"scoreSelf\":0,\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":10,\"qyestionContent\":\"九、上楼梯（上下一段楼梯，用手杖也算独立）\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"0=不能\\n5=需帮助（体力或语言指导）\\n10=自理\",\"isFalse\":2,\"remarks\":\"\",\"scoreSelf\":0,\"noMake\":0},{\"qyestionType\":\"主观\",\"qyestionScore\":5,\"qyestionContent\":\"十、洗澡\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"0=依赖\\n5=自理\",\"isFalse\":2,\"remarks\":\"\",\"scoreSelf\":0,\"noMake\":0}]', '', NULL, NULL, NULL, '2023-05-18 11:23:41', NULL);
...
INSERT INTO `familybasic` VALUES (52, 90, 0, '', '', '', '', '', '', '', '', '', '', '', '');
INSERT INTO `familybasic` VALUES (53, 91, 0, '', '', '', '', '', '', '', '', '', '', '', '');
INSERT INTO `familybasic` VALUES (54, 92, 0, '', '', '', '', '', '', '', '', '', '', '', '');
INSERT INTO `familybasic` VALUES (55, 93, 0, '', '', '', '', '', '', '', '', '', '', '', '');
INSERT INTO `familybasic` VALUES (56, 94, 0, '', '', '', '', '', '', '', '', '', '', '', '');
INSERT INTO `familybasic` VALUES (57, 95, 0, '', '', '', '', '', '', '', '', '', '', '', '');
INSERT INTO `familybasic` VALUES (58, 96, 0, '', '', '', '', '', '', '', '', '', '', '', '');
INSERT INTO `familybasic` VALUES (59, 97, 0, '', '', '', '', '', '', '', '', '', '', '', '');
...
CREATE TABLE `familymember`  (
  ...
  `deleteTime` datetime NULL DEFAULT NULL COMMENT '删除时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '家庭成员表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `growup` VALUES (46, 90, 0, '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '');
INSERT INTO `growup` VALUES (47, 91, 0, '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '');
INSERT INTO `growup` VALUES (48, 92, 0, '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '');
INSERT INTO `growup` VALUES (49, 93, 0, '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '');
INSERT INTO `growup` VALUES (50, 94, 0, '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '');
INSERT INTO `growup` VALUES (51, 95, 0, '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '');
INSERT INTO `growup` VALUES (52, 96, 0, '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '');
INSERT INTO `growup` VALUES (53, 97, 0, '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '');
...
INSERT INTO `love` VALUES (58, 90, '', '', '', '', '', '', '', '', '', '', '');
INSERT INTO `love` VALUES (59, 91, '', '', '', '', '', '', '', '', '', '', '');
INSERT INTO `love` VALUES (60, 92, '', '', '', '', '', '', '', '', '', '', '');
INSERT INTO `love` VALUES (61, 93, '', '', '', '', '', '', '', '', '', '', '');
INSERT INTO `love` VALUES (62, 94, '', '', '', '', '', '', '', '', '', '', '');
INSERT INTO `love` VALUES (63, 95, '', '', '', '', '', '', '', '', '', '', '');
INSERT INTO `love` VALUES (64, 96, '', '', '', '', '', '', '', '', '', '', '');
INSERT INTO `love` VALUES (65, 97, '', '', '', '', '', '', '', '', '', '', '');
...
INSERT INTO `physiology` VALUES (54, 90, '', '', '', '', '', '');
INSERT INTO `physiology` VALUES (55, 91, '', '', '', '', '', '');
INSERT INTO `physiology` VALUES (56, 92, '', '', '', '', '', '');
INSERT INTO `physiology` VALUES (57, 93, '', '', '', '', '', '');
INSERT INTO `physiology` VALUES (58, 94, '', '', '', '', '', '');
INSERT INTO `physiology` VALUES (59, 95, '', '', '', '', '', '');
INSERT INTO `physiology` VALUES (60, 96, '', '', '', '', '', '');
INSERT INTO `physiology` VALUES (61, 97, '', '', '', '', '', '');
...
CREATE TABLE `placement`  (
  ...
  `schoolName` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '学校名称',
  `from` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '原有安置方式',
  `to` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '转换后安置方式',
  `toId` int NULL DEFAULT NULL COMMENT '转换后的安置Id',
  `pass` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '是否通过',
  `createTime` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `other` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '其他',
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `placement` VALUES (1, 52, '茶杯', 7, '相城元和学校', '特殊学校', '送教上门', 4, '驳回', '2023-05-22 12:32:20', '123');
INSERT INTO `placement` VALUES (2, 52, '茶杯', 7, '相城元和学校', '特殊学校', '普校特教班', 3, '通过', '2023-05-23 11:30:01', NULL);
INSERT INTO `placement` VALUES (5, 52, '茶杯', 7, '相城元和学校', '特殊学校', '无', 8, '待审批', '2023-05-23 12:45:10', NULL);
...
CREATE TABLE `plan`  (
  ...
  `perception` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  ...
  `cognition` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `socialize` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `life` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  ...
  `startYear` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
...
) ENGINE = InnoDB AUTO_INCREMENT = 56 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '量表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `scale` VALUES (49, 27, '义务段融合状况评估', '[{\"qyestionType\":\"多选\",\"qyestionScore\":0,\"qyestionContent\":\"一、生理方面(请尽量勾选适合的所有项目，可以复选)\",\"select\":[{\"value\":\"身体状况长期不佳，常因病请假或缺课\",\"name\":\"A\"},{\"value\":\"由医院诊断现罹患有慢性疾病(___________病)\",\"name\":\"B\"},{\"value\":\"曾罹患过重大疾病(___________病_____岁时罹患)\",\"name\":\"C\"},{\"value\":\"生理动作发展较一般孩子明显的迟缓\",\"name\":\"D\"},{\"value\":\"体质特别差，无法在一般教室（需要哪些调整？         ）\",\"name\":\"E\"},{\"value\":\"生理状况与一般同年龄孩子差异不大(或差不多健康)\",\"name\":\"F\"}],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[]},{\"qyestionType\":\"多选\",\"qyestionScore\":0,\"qyestionContent\":\"二、感官动作方面(请尽量勾选适合的所有项目，可以复选)\",\"select\":[{\"value\":\"已领有残疾证(等级:______级，残疾类别:____________类)\",\"name\":\"A\"},{\"value\":\"有严重视力问题（类型：   近视，   远视，   其他          ）\",\"name\":\"B\"},{\"value\":\"经常揉眼睛，看东西会眯眼睛或贴课本或桌面贴得很近\",\"name\":\"C\"},{\"value\":\"发音不清楚，或声调不对\",\"name\":\"D\"},{\"value\":\"经常要别人大声说话或请人靠近一点再重说一遍\",\"name\":\"E\"},{\"value\":\"经常会跌倒或碰撞东西\",\"name\":\"F\"},{\"value\":\"动作明显的比一般同学慢很多\",\"name\":\"G\"},{\"value\":\"不大会(或很少)拿剪刀、筷子等需要手部精细动作的工具\",\"name\":\"H\"},{\"value\":\"不大会(或很少)跳绳、走平衡木、打球或一般学校操场的体能活动\",\"name\":\"I\"},{\"value\":\"不太会独立行走，需要轮椅、柺杖或家具等辅助工具或他人的协助\",\"name\":\"J\"},{\"value\":\"感官动作方面的发展与一般同年龄孩子差异不大，甚至更好\",\"name\":\"K\"}],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[]},{\"qyestionType\":\"多选\",\"qyestionScore\":0,\"qyestionContent\":\"三、学业表现方面(请尽量勾选适合的所有项目，可以复选)\",\"select\":[{\"value\":\"整体学业成绩长期(一学年以上)为全班最后五名\",\"name\":\"A\"},{\"value\":\"部分科目长期(一学年以上)为全班最后五名\",\"name\":\"B\"},{\"value\":\"学业表现经常起伏很大，可以由中等以上滑落到全班倒数\",\"name\":\"C\"},{\"value\":\"整体学业成绩自____年级起突然下滑，从此一蹶不振\",\"name\":\"D\"},{\"value\":\"部分学科(________科)自___年级起下滑，从此一蹶不振\",\"name\":\"E\"},{\"value\":\"不会拼音\",\"name\":\"F\"},{\"value\":\"不会认字，或会认读的字很少(比一般同学少很多)\",\"name\":\"G\"},{\"value\":\"无法读课本或考卷说明\",\"name\":\"H\"},{\"value\":\"阅读不流畅\",\"name\":\"I\"},{\"value\":\"无法理解课文大意或复述阅读内容的重点\",\"name\":\"J\"},{\"value\":\"会抄写但不知词汇意义\",\"name\":\"K\"},{\"value\":\"写字困难，连仿写或抄联络簿有困难\",\"name\":\"L\"},{\"value\":\"不会写出完整通顺的句子(尚未教到者，请在此□打X)\",\"name\":\"M\"},{\"value\":\"不会分类，如依据颜色、大小或形状等性质区分\",\"name\":\"N\"},{\"value\":\"不会一对一的数数\",\"name\":\"O\"},{\"value\":\"只能背出20以下的数字\",\"name\":\"P\"},{\"value\":\"需要手指协助运算加减\",\"name\":\"Q\"},{\"value\":\"会加减运算，但不会解应用问题\",\"name\":\"R\"},{\"value\":\"会加减，但不会乘除(尚未教到者，请在此□打X)\",\"name\":\"S\"},{\"value\":\"会加减乘除的运算，但不会解应用问题(尚未教到者，请在此□打X)\",\"name\":\"T\"},{\"value\":\"虽然学过小数、分数，但小数、分数或比例的概念差，不会运用(尚未      教到者，请在此□打X)\",\"name\":\"U\"},{\"value\":\"请务必选答此题。该生现有之学业表现大致如何？请依各项勾选： ** （1）整体学业：○1□中等以上           ○2□全班平均数左右                ○3□中下到最后30%     ○4□全班最后15%   （2）数学：  ○1□中等以上           ○2☑全班平均数左右                ○3□中下到最后30%     ○4□全班最后15%   （3）语文：  ○1□中等以上           ○2□全班平均数左右                ○3□中下到最后30%     ○4□全班最后15%\",\"name\":\"V\"}],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[]},{\"qyestionType\":\"多选\",\"qyestionScore\":0,\"qyestionContent\":\"四、学习能力方面(请尽量勾选适合的所有项目，可以复选)\",\"select\":[{\"value\":\"学习速度缓慢，明显的比一般同班同学较差\",\"name\":\"A\"},{\"value\":\"记忆力差，记不住当天老师或父母的交代\",\"name\":\"B\"},{\"value\":\"注意力差．不易持续专心任何活动\",\"name\":\"C\"},{\"value\":\"组织力差，说话或做事显得凌乱，没有重点与组织\",\"name\":\"D\"},{\"value\":\"理解能力差，常弄不清楚抽象或较复杂的符号或词汇\",\"name\":\"E\"},{\"value\":\"学习能力在不同事物表现差异很大，对某些科目或事物表现得特别好(与一般同学相比在中等以上)\",\"name\":\"F\"},{\"value\":\"记忆力好,尤其是对自己感兴趣的事物\",\"name\":\"G\"},{\"value\":\"学习能力大致与一般同年龄的同学差不多，甚至更好\",\"name\":\"H\"}],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[]},{\"qyestionType\":\"多选\",\"qyestionScore\":0,\"qyestionContent\":\"五、口语能力方面(请尽量勾选适合的所有项目，可以复选)\",\"select\":[{\"value\":\"口语能力表达差，无法与老师或同学沟通\",\"name\":\"A\"},{\"value\":\"听话理解能力差，常抓不到老师或同学说话的重点\",\"name\":\"B\"},{\"value\":\"不太能和别人闲谈，不太能接续别人的话题\",\"name\":\"C\"},{\"value\":\"说话不清楚，一般人不易听得懂\",\"name\":\"D\"},{\"value\":\"不喜欢听人讲解，听课比自己看书学习时显得不专心\",\"name\":\"E\"},{\"value\":\"经常重复简单的词汇或短句\",\"name\":\"F\"},{\"value\":\"不会主动表达自己的需求\",\"name\":\"G\"},{\"value\":\"口语能力与一般同年龄的同学差不多\",\"name\":\"H\"}],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[]},{\"qyestionType\":\"多选\",\"qyestionScore\":0,\"qyestionContent\":\"六、团体生活方面(请尽量勾选适合的所有项目，可以复选)\",\"select\":[{\"value\":\"上课经常会随意离开座位或教室\",\"name\":\"A\"},{\"value\":\"上课经常没有反应、呆坐或打瞌睡\",\"name\":\"B\"},{\"value\":\"无法参与团体活动(游戏、比赛)\",\"name\":\"C\"},{\"value\":\"喜欢一个人独处或自己玩\",\"name\":\"D\"},{\"value\":\"下课经常一个人，没有人和他玩\",\"name\":\"E\"},{\"value\":\"上课会乱出声、走动或作弄别人而影响教室学习\",\"name\":\"F\"},{\"value\":\"爱顶嘴，公开顶撞师长的指示\",\"name\":\"G\"},{\"value\":\"经常不交作业、或不做扫地工作\",\"name\":\"H\"},{\"value\":\"会逃课、逃家、或逃学\",\"name\":\"I\"},{\"value\":\"霸道，经常要别人让他，不能忍受同学的不一样或打扰\",\"name\":\"J\"},{\"value\":\"班上大多数同学都讨厌他，会拒绝与他同座或在一起\",\"name\":\"K\"},{\"value\":\"在学校与同学相处方面和一般同年龄孩子差不多\",\"name\":\"L\"}],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[]},{\"qyestionType\":\"多选\",\"qyestionScore\":0,\"qyestionContent\":\"七、个人生活适应方面(请尽量勾选所有适合的项目，可以复选)\",\"select\":[{\"value\":\"脏乱、无法维持个人卫生\",\"name\":\"A\"},{\"value\":\"不会自行穿脱衣服\",\"name\":\"B\"},{\"value\":\"不会自行上厕所，会遗尿或大便在裤子上\",\"name\":\"C\"},{\"value\":\"应变能力差，经常不会随着情境调整自己的行为或态度\",\"name\":\"D\"},{\"value\":\"动作速度经常跟不上教室(或班级团体)的活动脚步\",\"name\":\"E\"},{\"value\":\"不会自行由教室到厕所或学校内其他的地方\",\"name\":\"F\"},{\"value\":\"上课钟响经常不会自行回教室\",\"name\":\"G\"},{\"value\":\"经常忘记带上课需要的文具、书本或作业\",\"name\":\"H\"},{\"value\":\"经常遗失个人物品，不会保管自己的东西\",\"name\":\"I\"},{\"value\":\"在学校所从事的活动(休闲或社交活动)比一般同学少很多\",\"name\":\"J\"},{\"value\":\"对于环境不预期的变化（如调课、换座位）会有明显不适应的反应\",\"name\":\"K\"},{\"value\":\"可以像一般同年龄的同学照顾自己\",\"name\":\"L\"}],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[]},{\"qyestionType\":\"多选\",\"qyestionScore\":0,\"qyestionContent\":\"八、行为情绪适应方面(请尽量勾选所有适合的项目，可以复选)\",\"select\":[{\"value\":\"情绪表达不适当，和情境不合\",\"name\":\"A\"},{\"value\":\"退缩、胆子很小\",\"name\":\"B\"},{\"value\":\"脾气很大，经常会生很大的脾气、骂人\",\"name\":\"C\"},{\"value\":\"经常攻击同学或破坏物品\",\"name\":\"D\"},{\"value\":\"一不满意，就会哭闹不停\",\"name\":\"E\"},{\"value\":\"比一般同学更容易紧张、焦虑\",\"name\":\"F\"},{\"value\":\"不会保护自己，经常受同学欺负或占小便宜\",\"name\":\"G\"},{\"value\":\"待人处事或行为举止显得比一般同学幼稚、不成熟\",\"name\":\"H\"},{\"value\":\"对周遭的人或活动不太有反应，好像不感兴趣\",\"name\":\"I\"},{\"value\":\"经常重复出现相同的动作、或发出相同的声音\",\"name\":\"J\"},{\"value\":\"老师、同学生气或受伤时,不会表现出关心或担心的行为\",\"name\":\"K\"},{\"value\":\"对周遭的人感兴趣,但表现的很奇怪,令人受不了\",\"name\":\"L\"},{\"value\":\"行为与情绪表达与一般同年龄同性别的同学差不多\",\"name\":\"M\"}],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[]},{\"qyestionType\":\"多选\",\"qyestionScore\":0,\"qyestionContent\":\"九、家庭与社区方面（请尽量勾选适合的所有项目，可以复选）\",\"select\":[{\"value\":\"曾经长期（一年以上）居住在国外或偏远地区（国家_____或地区_____，共住多久_________）\",\"name\":\"A\"},{\"value\":\"放学后没有人可以提供课业上的协助或督导\",\"name\":\"B\"},{\"value\":\"放学后没有人会监控学生的行动\",\"name\":\"C\"},{\"value\":\"长期不和父母双亲同居住在一起     （目前的监护人与孩子的关系__________________）\",\"name\":\"D\"},{\"value\":\"家庭经济贫困（属于低收入户或主要家长长期失业）\",\"name\":\"E\"},{\"value\":\"家庭居住环境充满不好的影响（例如：电动玩具店、色情或赌博行业、帮派或犯罪组织）\",\"name\":\"F\"},{\"value\":\"父亲或母亲是外地户口（□父亲或□母亲，_______省）\",\"name\":\"G\"},{\"value\":\"家庭状况与一般同学差不多，或是更好\",\"name\":\"H\"}],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":0,\"qyestionContent\":\"十、其他：上面没有列出来项目，但根据您的观察，学生还有哪些需要被关心的问题?请尽量列举于下：\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[]}]', '请资源教师及班主任根据该生在普通班或其他教育环境学习情形，勾选出该生可能有的适应状况，请在下列九项每一大项中，请尽量勾选适合的所有项目，可以复选。如果没有适合的项目，至少勾选一项，务必考虑勾选每道题目的最后一项），题末注有**者，请务必填写。但请阅读所有项目，以免遗漏。', '2023-05-13 11:59:59', NULL, NULL);
INSERT INTO `scale` VALUES (50, 28, '学前融合状况评估表', '[{\"qyestionType\":\"主观\",\"qyestionScore\":16,\"qyestionContent\":\"一、学习方面--A.遵守常规\",\"select\":[{\"value\":\"1.有自己将东西收拾归位的习惯\",\"name\":\"A\"},{\"value\":\"2.可以静坐学习，不随意离座\",\"name\":\"B\"},{\"value\":\"3.愿意遵从老师的指令和要求\",\"name\":\"C\"},{\"value\":\"4.大部分时间能够配合班级作息活动\",\"name\":\"D\"}],\"isTrue\":[],\"subjectivity\":\"  1.有自己将东西收拾归位的习惯\\n  2.可以静坐学习，不随意离座\\n  3.愿意遵从老师的指令和要求\\n  4.大部分时间能够配合班级作息活动\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":16,\"qyestionContent\":\"一、学习方面--B.学习态度\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"  1.对多数的学习和活动有兴趣，并会主动参与\\n  2.会做的事愿意自己做(例如：                       )\\n  3.自由活动时能主动选择适当的活动∕玩具\\n  4.愿意主动探索环境及尝试新经验\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":24,\"qyestionContent\":\"一、学习方面--C.学习能力\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"  1.团体教学活动中可集中注意力一半以上的时间\\n  2.自由活动时间能专心进行活动约10-15分钟\\n  3.能独立完成老师交代的事务以及学习活动\\n  4.可理解大部分的上课内容\\n  5.能在团体中有效的学习，通常不须个别指导\\n  6.会模仿老师或同学正在进行的行为\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":12,\"qyestionContent\":\"一、学习方面--C.安全意识\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"1.集体行动或外出时不乱跑脱队，或离开老师视线范围\\n2.能判断危险的事物并加以避免(例如：                )\\n3.能安全的使用日常用品\\n\\n其他学习方面的特质：\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":44,\"qyestionContent\":\"二、情绪与社交游戏方面\",\"select\":[{\"value\":\"1.维持稳定的情绪，不随意发脾气\",\"name\":\"A\"}],\"isTrue\":[],\"subjectivity\":\"  1.维持稳定的情绪，不随意发脾气\\n  2.会用适当的方式表达自己的情绪\\n  3.知道如何保护自己和自己的东西\\n  4.很少干扰其他的小朋友上课或游戏\\n  5.知道班上至少一半小朋友的名字\\n  6.会和几位小朋友一起玩\\n  7.主动和几位熟悉的小朋友互动\\n  8.有轮流和等待的耐性\\n  9.可与人合作完成工作或游戏\\n  10.会和人玩有规则的竞争性游戏\\n  11.可以和老师维持良好的互动关系\\n\\n其他情绪与社交游戏方面的特质：\",\"Single\":[0]},{\"qyestionType\":\"主观\",\"qyestionScore\":52,\"qyestionContent\":\"三、个人自理方面\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"  1.会自己进食，并且维持干净\\n  2.愿意尝试多种食物\\n  3.会自己穿∕脱鞋袜\\n  4.会自己穿∕脱衣裤\\n  5.会自己摺叠或悬挂衣物\\n  6.主动表示如厕意愿，很少有意外发生\\n  7.如厕后会整理衣着∕擦拭\\n  8.会自己用卫生纸擤鼻涕\\n  9.会自己把手洗干净\\n  10.会自己刷牙\\n  11.午休时间会入眠或可安静休息\\n  12.收拾好自己的所有物放在固定的地方\\n  13口渴、累了或不舒服时会主动表达\\n\\n其他生活自理方面的特质：\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":40,\"qyestionContent\":\"四、认知方面\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"  1.认识园所中常见物品的名称∕功能\\n  2.会指认故事书或海报中的图案\\n  3.认识三角形、圆形、正方形\\n  4.认识至少三种不同的颜色\\n  5.有对比概念如：大小、长短、高矮、多少和轻重等\\n  6.会做实物或图卡的配对\\n  7.会做实物或图卡的分类\\n  8.理解上下、前后、里外等基本空间概念\\n  9.会指认五个阿拉伯数字\\n  10.有数量1-5的概念(知道东西有几个)\\n\\n其他认知方面的特质：\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":20,\"qyestionContent\":\"五、粗大动作与音乐律动方面\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"  1.会使用常见的游乐设施和运动器材\\n  2.肢体动作灵活，不会显得僵硬或常跌倒\\n  3.愿意参与体能活动\\n  4.愿意参与音乐活动\\n  5.会哼唱简单的歌曲\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":28,\"qyestionContent\":\"六、精细动作与美劳技能方面\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"  1.手眼协调动作不错，会操作教室里大部分的玩具∕教具\\n  2.会画圆圈\\n  3.会画简单的图案(例如：苹果、房子、车子……)\\n  4.会在范围内着色\\n  5.会做一般图案或实物的黏贴工作\\n  6.使用剪刀剪线段\\n  7.愿意参与美劳活动\\n\\n其他生理动作能力方面的特质：\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":52,\"qyestionContent\":\"七、沟通语言方面\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"  1.理解教室中常用的简单指令\\n  2.理解较复杂的指令\\n  3.会用动作∕表情来表达需求和想法\\n  4.会用适当语汇及完整句来表达需求和想法\\n  5.会主动用口语或非口语与人沟通(例如：询问、发表意\\n    见、请求协助、拒绝)\\n  6.会唸教过的童谣\\n  7.对老师的问题会加以适当的回应\\n  8.和大人或小朋友能有来有往地对话、闲谈\\n  9.老师可以大致理解孩子想表达的意思(动作表示亦可)\\n  10.老师可以听懂孩子所说的话\\n  11.会专心听故事，并理解重要的内容\\n  12.会参与团体讨论或讨论故事内容\\n  13.会简单叙述自己的经验\\n\\n其他沟通能力方面的特质：\",\"Single\":[]}]', 'A.	评量方式：依幼儿融合状况实际表现，分为四个等级\n           4分：很好或经常做的到\n           3分：表现平平或半数时间做的到\n           2分：尚待加强或有时做的到\n           1分：很差或几乎都做不到\nB.	本评量不足之处，园所可依自己的需求修改项目，或于说明栏中注明\nC.	评量时间：第一次是幼儿入学一个月内，以后则约每三至四个月再次评量。\n', '2023-05-13 13:24:12', NULL, NULL);
INSERT INTO `scale` VALUES (51, 29, '个案在校观察记录表', '[{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"课堂表现\",\"select\":[{\"value\":\"\",\"name\":\"A\"}],\"isTrue\":[],\"subjectivity\":\"1.上课遵守课堂纪律。\\t　\\t一节课平均能维持（   ）分钟\",\"Single\":[0]},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"课堂表现\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"2.能够按照老师的指示参与课堂活动。\\t　\\t一节课平均能维持（   ）分钟\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"课堂表现\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"3.上课认真听讲。\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"课堂表现\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"4.积极举手发言。\\t　\\t平均（   ）次/节课，回答正确率约（  ）\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"课堂表现\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"5.回答问题时声音响亮。\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"课堂表现\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"6.能否参加配对或分组的教学活动。\\t　\\t“否”请注明原因：\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"课堂表现\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"7.能否在规定时间内完成当堂作业。\\t　\\t“否”请注明原因：\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"课堂表现\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"8.上课不出声吵闹。\\t　\\t吵闹频数：（   ）次/节课\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"课堂表现\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"9.能保持稳定的情绪，不随意发脾气。\\t　\\t一般能维持（   ）分钟情绪平稳\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"课堂表现\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"10.不擅自离开自己的座位。\\t　\\t平均（   ）次/节课\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"课堂表现\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"11.坐姿正确，不摇晃脑袋或身体。\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"课堂表现\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"12.不乱动同学的书本或文具。\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"课堂表现\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"13.上课不吃零食。\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":0,\"qyestionContent\":\"课堂表现\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"备注（补充其它需要关注的课堂表现）：\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"作业完成情况\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"1.按时完成课后作业。\\t　\\t“否”请注明原因：\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"作业完成情况\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"2.不少做.漏做作业。\\t　\\t“否”请注明原因：\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"作业完成情况\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"3.作业符合要求。\\t　\\t“否”请注明原因：\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"作业完成情况\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"4.字迹工整。\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"作业完成情况\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"5.完成质量较好/正确率较高。\\t　\\t正确率大约为（   ）%\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"作业完成情况\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"6.订正及时.正确。\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"作业完成情况\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"备注（补充其它需要关注的作业完成情况）：\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"言语沟通\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"1.不无故自言自语。\\t　\\t“否”请注明频数：（  ）次/（   ） \",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"言语沟通\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"2.不鹦鹉学舌地重复别人的话。\\t　\\t“否”请注明频数：（  ）次/（   ）\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"言语沟通\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"3.与人说话时，眼睛注视对方。\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"言语沟通\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"4.别人与他说话时，会有适当的回应并看着对方。\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"言语沟通\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"5.发音清晰。\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"言语沟通\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"6.能用语言表达自己的需求。\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"言语沟通\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"7.说话较流利，不结巴或断断续续。\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"言语沟通\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"8.说话有意义，符合语境与逻辑。\\t　\\t“否”请试举例：\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"言语沟通\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"9.说话有条理，而非“前言不搭后语”。\\t　\\t“否”请试举例：\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"言语沟通\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"10.会使用基本的礼貌用语。\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":0,\"qyestionContent\":\"言语沟通\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"备注：\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"同伴关系\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"1.下课与同学一起玩耍。\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"同伴关系\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"2.体育课上参加集体游戏或活动。\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"同伴关系\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"3.能与同学建立起友谊。\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"同伴关系\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"4.有两三个固定的好朋友。\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"同伴关系\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"5.能与同学互帮互助。\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"同伴关系\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"6.团结同学。\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"同伴关系\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"7.与班级同学相处融洽。\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"同伴关系\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"8.人缘较好。\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"同伴关系\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"9.能主动与同学交往。\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":0,\"qyestionContent\":\"同伴关系\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"备注：\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"自理能力\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"1.仪容整洁。\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"自理能力\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"2.有良好的个人卫生习惯。\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"自理能力\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"3.上下学不迟到.早退。\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"自理能力\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"4.自己吃午饭。\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"自理能力\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"5.饮食适度。\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"自理能力\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"6.如厕自理。\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"自理能力\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"7.能看管好自己的东西。\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":0,\"qyestionContent\":\"自理能力\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"备注：\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"不良行为\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"1.有刻板行为。\\t　\\t“是”请注明频数：（   ）次/（   ）\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"不良行为\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"2.有明显的对抗性行为（如不听老师的指导或不遵守规章制度等）。\\t“是”请注明频数：（   ）次/（   ）\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"不良行为\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"3.有攻击性行为（如用脏话骂人.向别人扔东西等）。\\t　\\t“是”请注明频数：（   ）次/（   ）\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"不良行为\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"4.有反社会性行为（如从别人手中抢东西或喜欢给人找麻烦）。\\t　\\t“是”请注明频数：（   ）次/（   ）\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"不良行为\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"5.脾气不稳定，动不动就发脾气。\\t　\\t“是”请注明频数：（   ）次/（   ）\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"不良行为\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"6.不与人交往，喜欢独来独往。\\t　\\t“是”请注明原因：\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":2,\"qyestionContent\":\"不良行为\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"7.有自伤行为（如经常咬伤自己的手.用力撞墙等）。\\t　\\t“是”请注明频数：（   ）次/（   ）\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":0,\"qyestionContent\":\"不良行为\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"备注：\",\"Single\":[]}]', '请根据学生两周的表现，对每一项内容进行客观的评价： \n基本能做到计“2”表示，\n不能做到计“0”表示\n偶尔（非经常）能做到计“ 1 ”表示。\n', '2023-05-13 16:32:14', NULL, NULL);
INSERT INTO `scale` VALUES (52, 21, '基于ICF-CY编码的功能性评估--活动和参与', '[{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"活动和参与\",\"select\":[{\"value\":\"\",\"name\":\"A\"}],\"isTrue\":[],\"subjectivity\":\"d140  学习阅读\",\"Single\":[0]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"d145  学习书写\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"d150  学习计算\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"d160  集中注意力于特定刺激，过滤噪音\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"d166  阅读（如理解力，即大声读或默读并理解文本以获取信息）\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"d170  书写（如传达信息，拟定书面文本的理解，拼写，语法）\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"d172  计算（如执行计算和应用数学原理）\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"d175  解决问题（如找到问题或处境的解答）\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"d177  做决策或在不同的可能之间进行选择（例如不同的食物、玩具、休闲活动）\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"d161  引导注意力（例如专注于具体任务或行动）\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"d163  思考（例如形成观念，反映、思考、分析信息）\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"d220  开展多个任务或对多个组件或序列的命令作出反应（如穿衣、吃饭或采取一系列指令）\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"d230  进行日常工作（例如早上起床、准备上学、规划时间）\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"d240  处理压力与其他精神需求（如考试、在拥挤的交通中前行、排队、处理困难等）\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"d250  管理个人行为（如适应和应对异常情况、管理情绪的表达）\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"d320  理解肢体语言、一般标志符号、图片等中非语言信息的意义的能力\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"d350  交谈（例如发起、保持、形成或终止沟通互动）\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"d520  照顾身体（如刷牙、梳头、修剪等）\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"d510  清洗自身（如洗澡、洗手等）\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"d540  依据不同场合穿着打扮自身\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"d571  避免危险状况和伤害自身\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"d710  人际互动（基本的人际互动，如对他人感觉有回应，展示尊重，适当的身体接触等。）\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"d760  创建和保持家庭关系\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"d720  以情境和社交适当方式，形成、维持和管理与他人的互动\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"d820  学校教育（如和其他学生合作，听从教师指导，学习材料，做作业等）\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"d920  娱乐和休闲（随意的或有组织的游戏和运动，艺术和文化，工艺，嗜好，乐器演奏等）\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"d880  从事游戏（自身或与他人忙于有目的、持续的从事物品、玩具、器材或赛局的活动。）\",\"Single\":[]}]', '评价标准：0=无障碍；1=有时5-24%不集中，不影响生活；2=时常25-49%不集中，影响生活；3=经常50-95%出现，严重影响生活；4=极难或完全不能', '2023-05-15 21:43:00', NULL, NULL);
INSERT INTO `scale` VALUES (53, 21, '基于ICF-CY编码的功能性评估----环境因素', '[{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"e310  直系亲属的支持程度\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"e1110  饮食（例如饮食的适当性，营养，数量，和连贯性）\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"e1101  药品（医疗用途的药物类型和数量）\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"e115  个人日常生活使用的产品和技术(例如家具，童车，椅子，个人护理设备，改装或特别设计的设备，骨科器械)\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"e125  用于沟通的产品和技术（例如电话，电视和录音设备，电脑或电子邮件，眼镜和视听力辅助设备，书写辅助设备等）\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"e130  教育产品和技术（书籍，电脑，益智玩具，为学习而设计的工具，如计算机软件等）\\t\\t\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"e320  有固定的朋友（1-2个，伙伴关系良好）\\t\\t\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"e410  直系亲属成员个体态度（对儿童成长的期望）\\t\\t\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"e420  朋友个体态度（包容的班级环境）\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"e155  私人使用建筑物的设计、建构和建筑产品和技术（校园及家庭无障碍环境的创设：例如门槛，坡道，门把，厕所，照明，对比的颜色，厨房内部）\\t\\t\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"e150  公共使用建筑物的设计、建构和建筑产品和技术（例如入口，电梯，开门器，标志，助听装置，图片支持，盲文，安全设备等）\\t\\t\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"e575  社会支持的服务、制度和政策（社会保障以外的公共援助）\\t\\t\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"e580  健康服务（例如早期干预，技术支持和其他健康服务）\\t\\t\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[]}]', '评价标准：0=无障碍；1=有时5-24%不集中，不影响生活；2=时常25-49%不集中，影响生活；3=经常50-95%出现，严重影响生活；4=极难或完全不能', '2023-05-15 21:57:27', NULL, NULL);
INSERT INTO `scale` VALUES (54, 21, '基于ICF-CY编码的功能性评估----身体功能', '[{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"b110  基本心理功能（例如觉察和推理，理解任务要求以及如何解决问题）\\t\\t\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"b126  气质和人格功能（如外向、随和、精神的稳定性等）\\t\\t\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"b130  精力和驱使功能（例如产生活力，耐力，激励，常规冲动，和饮食欲望或本能的心理功能）\\t\\t\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"b134  睡眠功能（睡眠的数量及起始，睡眠的维持和质量）\\t\\t\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"b140  注意力功能（注意力的保持、转换、分配及分享；专注）\\t\\t\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"b144  记忆力功能（例如记忆、学习及回忆）\\t\\t\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"b147  精神运动的控制（如惯用手和侧边优势，坐立姿态，精神运动功能质量，有关语言运动的速度调节）\\t\\t\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"b152  情绪调节和情绪范围（例如情感的适当性：如爱意、仇恨、焦虑、伤心、高兴、恐惧和愤怒。）\\t\\t\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"b160  思想功能（例如控制思想的步调、形式和内容，目标导向的和逻辑的思想，思想的一致性）\\t\\t\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"b164  具体心理功能（例如抽象思维，制定和执行计划，做决策）\\t\\t\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"b167  语言心理功能（例如识别和使用口语，书面或其他形式（如标志，图片，象形图等）的语言）\\t\\t\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"B210  视觉功能\\t\\t\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"b230 听觉功能\\t\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"b235 前庭功能\\t\\t\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"b250 味觉功能\\t\\t\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"b255 嗅觉功能\\t\\t\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"b260 本体感觉功能\\t\\t\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"b265 触觉功能\\t\\t\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"b320  发音功能\\t\\t\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"b330  语言的流畅（例如语言的流畅和节奏等）\\t\\t\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"b410  心脏功能（例如心率，心脏节律，心脏瓣膜，血压，循环功能）\\t\\t\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"b4350  免疫反应（例如抗感染）\\t\\t\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"b440  呼吸功能（例如呼吸节奏，呼吸频率，呼吸深度）\\t\\t\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"b530  体重维持功能（例如适当的体质指数，包括体重增加）\\t\\t\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"b560  生长维持功能（获得预期生长里程碑）\\t\\t\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"b735  肌肉张力功能（例如肌肉静止所呈现张力与尝试被动地移动肌肉时所提供阻力相关的功能，呈现为肌无力，肌张力增高，痉挛等。）\\t\\t\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[]},{\"qyestionType\":\"主观\",\"qyestionScore\":4,\"qyestionContent\":\"b760  随意运动（例如控制和协调，呈现为笨拙和轮替运动困难等）\\t\\t\",\"select\":[],\"isTrue\":[],\"subjectivity\":\"\",\"Single\":[]}]', '评价标准：0=无障碍；1=有时5-24%不集中，不影响生活；2=时常25-49%不集中，影响生活；3=经常50-95%出现，严重影响生活；4=极难或完全不能', '2023-05-15 22:12:16', NULL, NULL);
INSERT INTO `scale` VALUES (55, 14, '123', '[{\"qyestionType\":\"单选\",\"qyestionScore\":3,\"qyestionContent\":\"1+1\",\"select\":[{\"value\":\"1\",\"name\":\"A\"},{\"value\":\"2\",\"name\":\"B\"},{\"value\":\"3\",\"name\":\"C\"},{\"value\":\"4\",\"name\":\"D\"}],\"isTrue\":\"B\",\"subjectivity\":\"\",\"Single\":[0,0,0,0]},{\"qyestionType\":\"单选\",\"qyestionScore\":3,\"qyestionContent\":\"2+2\",\"select\":[{\"value\":\"2\",\"name\":\"A\"},{\"value\":\"3\",\"name\":\"B\"},{\"value\":\"4\",\"name\":\"C\"},{\"value\":\"5\",\"name\":\"D\"}],\"isTrue\":\"C\",\"subjectivity\":\"\",\"Single\":[0,0,0,0]}]', '', '2023-05-18 11:09:50', NULL, NULL);
...
CREATE TABLE `scaleclassify`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 30 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '量表分类' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `scaleclassify` VALUES (27, '融合状况和在校观察', '融合状况', '义务段融合状况评估');
INSERT INTO `scaleclassify` VALUES (28, '融合状况和在校观察', '融合状况', '学前融合状况评估表');
INSERT INTO `scaleclassify` VALUES (29, '融合状况和在校观察', '个案在校观察', '个案在校观察记录表');
...
CREATE TABLE `schedule`  (
  ...
  `schedule` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '课表',
...
-- ----------------------------
-- Table structure for schoolhome
-- ----------------------------
DROP TABLE IF EXISTS `schoolhome`;
CREATE TABLE `schoolhome`  (
  `id` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `studentId` int NULL DEFAULT NULL,
  `studentName` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `startYear` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  ...
  `semester` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `teacherName` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `situation` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
...
CREATE TABLE `special`  (
  ...
  `semester` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `teacherName` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `basicArea` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `gbArea` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `targetArea` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `psychologyArea` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
...
CREATE TABLE `studentbasic`  (
  ...
  `cardId` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '身份证号',
  `obstacleCardId` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '残疾证号',
  ...
  `studentStatus` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '学籍状态',
...
INSERT INTO `studentbasic` VALUES (10, 52, '123', '2023-03-13 00:00:00', '轻度', 5, '1231231', '123', '汉族', 'A型', '中国', '12655', '123', '123', '220723', NULL);
INSERT INTO `studentbasic` VALUES (11, 53, '', '2006-04-06 00:00:00', '轻中度', 3, '', '', '汉', '', '', '', '', '', '', '');
INSERT INTO `studentbasic` VALUES (12, 54, '999', NULL, '', NULL, '111', '', '', '', '', '', '', '', '', '');
...
INSERT INTO `studentbasic` VALUES (46, 88, '', '2015-04-08 00:00:00', '', NULL, '123', '', '', '', '', '', '', '', '', '');
INSERT INTO `studentbasic` VALUES (47, 89, '', NULL, '轻中度', 6, '', '', '', 'B型', '中国', '', '', '', '', '');
INSERT INTO `studentbasic` VALUES (48, 90, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '');
INSERT INTO `studentbasic` VALUES (49, 91, '', NULL, '', NULL, '2002020202020', '', '', '', '', '123456789', '', '', '', NULL);
INSERT INTO `studentbasic` VALUES (50, 92, '123', NULL, '', NULL, '666', '', '', '', '', '777', '', '', '', NULL);
INSERT INTO `studentbasic` VALUES (51, 93, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '');
INSERT INTO `studentbasic` VALUES (52, 94, '', NULL, '', NULL, '888', '', '', '', '', '777', '', '', '', NULL);
INSERT INTO `studentbasic` VALUES (53, 95, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '');
INSERT INTO `studentbasic` VALUES (54, 96, '', NULL, '', NULL, '1234', '', '', '', '', '5678', '', '', '', NULL);
INSERT INTO `studentbasic` VALUES (55, 97, '', NULL, '', NULL, '890890', '', '', '', '', '789789', '', '', '', NULL);
...
INSERT INTO `teacher` VALUES (28, 1, '马超', '马超', '123123', 'https://static.yirenyian.com/opoc/sysImg/avatar-boy.png', '男', '12312312312', '123123@qq.com', '2023-04-08 02:15:15', '2023-05-04 22:37:34', '2023-05-04 22:37:34', '否', NULL);
...
INSERT INTO `teacher` VALUES (30, 7, 'zgl', '诸葛亮', '123123', 'https://static.yirenyian.com/opoc/sysImg/avatar-boy.png', '男', '12312312312', '123123123@qq.com', '2023-04-10 09:02:27', '2023-05-23 10:27:38', NULL, '是', NULL);
INSERT INTO `teacher` VALUES (31, 12, 'cc', '曹操', '123123', 'https://static.yirenyian.com/opoc/sysImg/avatar-boy.png', '男', '19823123234', '123123454@qq.com', '2023-04-10 09:03:24', '2023-05-18 19:25:16', NULL, '是', NULL);
...
CREATE TABLE `transfer`  (
  ...
  `studentId` int NULL DEFAULT NULL COMMENT '学生Id',
  `studentName` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '学生姓名',
  `fromSchoolId` int NULL DEFAULT NULL COMMENT '从哪个学校发起中转',
  `fromSchollName` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '学校名称',
  `fromRegionCode` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '所在地区',
  `toSchoolId` int NULL DEFAULT NULL COMMENT '转到哪个学校',
  `toSchoolName` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '学校名称',
  `toRegionCode` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '接受地',
  `startTime` datetime NULL DEFAULT NULL COMMENT '起始时间',
  `schoolTime` datetime NULL DEFAULT NULL COMMENT '学校发起时间',
  `centerTime` datetime NULL DEFAULT NULL COMMENT '特教中心处理时间',
  `boardTime` datetime NULL DEFAULT NULL COMMENT '委员会处理时间',
  `endTime` datetime NULL DEFAULT NULL COMMENT '接受时间',
  `status` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '状态',
  `other` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '原因',
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of transfer
-- ----------------------------
INSERT INTO `transfer` VALUES (1, 1, '王魁你', 1, '苏州信息', '321202', 2, '元和', '321202', '2023-05-12 09:52:34', '2023-05-12 09:52:38', '2023-05-12 10:23:22', '2023-05-12 10:24:57', NULL, '驳回', NULL);
INSERT INTO `transfer` VALUES (2, 3, '王魁你', 1, '苏州信息', '321202', 2, '元和', '321202', '2023-05-12 10:14:03', '2023-05-12 10:14:07', '2023-05-12 10:14:11', NULL, NULL, '驳回', '信息不完善');
INSERT INTO `transfer` VALUES (4, 2, '猹', 1, '苏州信息', '321202', 2, '元和', '321202', '2023-05-13 10:00:54', '2023-05-13 10:02:37', '2023-05-13 10:02:41', '2023-05-15 10:51:47', NULL, '通过', '');
INSERT INTO `transfer` VALUES (5, 52, '茶杯', 9, NULL, '321202', 12, '南师大小学', '321202', '2023-05-13 15:07:48', '2023-05-13 15:07:48', '2023-05-15 08:47:52', '2023-05-15 10:49:01', NULL, '通过', NULL);
INSERT INTO `transfer` VALUES (6, 52, '茶杯', 1, NULL, '321202', 12, '南师大小学', '321202', '2023-05-13 15:48:06', '2023-05-13 15:48:06', '2023-05-15 08:47:55', NULL, NULL, '驳回', '信息不完善');
